...
public class PropBDD extends AbsPropagator {
    ...
    protected void outputPt(final jedd.internal.RelationContainer pt) {
        ...
        ptout.add(new jedd.internal.RelationContainer(new Attribute[] { objc.v(), varc.v(), var.v(), obj.v() },
                                                      ...
                                                      ("ptout.add(jedd.internal.Jedd.v().replace(toOutput, new jedd." +
                                                       ...
                                                       "/research/ccl/olhota/soot-trunk/src/soot/jimple/paddle/PropB" +
                                                       "DD.jedd:51,8-13"),
    ...
    protected jedd.internal.RelationContainer propLoad(final jedd.internal.RelationContainer fpt,
        ...
        loadsFromHeap.eq(jedd.internal.Jedd.v().replace(jedd.internal.Jedd.v().compose(jedd.internal.Jedd.v().read(jedd.internal.Jedd.v().replace(load,
                                                                                                                                                  new PhysicalDomain[] { V1.v(), V2.v(), C2.v() },
                                                                                                                                                  new PhysicalDomain[] { V2.v(), V1.v(), C3.v() })),
    ...
    public boolean update() {
        ...
        pt.eqUnion(jedd.internal.Jedd.v().replace(jedd.internal.Jedd.v().intersect(jedd.internal.Jedd.v().read(jedd.internal.Jedd.v().replace(newAlloc.get(),
                                                  ...
                                                  new PhysicalDomain[] { C3.v(), V1.v(), H1.v() },
                                                  new PhysicalDomain[] { C1.v(), V2.v(), H2.v() }));
        pt.eqUnion(jedd.internal.Jedd.v().intersect(jedd.internal.Jedd.v().read(propSimple(new jedd.internal.RelationContainer(new Attribute[] { objc.v(), varc.v(), var.v(), obj.v() },
                                                                                                                               ...
                                                                                                                               ("propSimple(jedd.internal.Jedd.v().replace(pt, new jedd.Physi" +
                                                                                                                                ...
                                                                                                                                "imple/paddle/PropBDD.jedd:107,14-24"),
        ...
        fieldPt.eqUnion(propStore(new jedd.internal.RelationContainer(new Attribute[] { objc.v(), varc.v(), var.v(), obj.v() },
                                                                      ...
                                                                      ("propStore(jedd.internal.Jedd.v().replace(pt, new jedd.Physic" +
                                                                       ...
                                                                       "/jimple/paddle/PropBDD.jedd:110,19-28"),
                                                                      jedd.internal.Jedd.v().replace(pt,
                                  ...
                                  new jedd.internal.RelationContainer(new Attribute[] { objc.v(), varc.v(), var.v(), obj.v() },
                                                                      ...
                                                                      ("propStore(jedd.internal.Jedd.v().replace(pt, new jedd.Physic" +
                                                                       ...
                                                                       "/jimple/paddle/PropBDD.jedd:110,19-28"),
                                                                      pt)));
        pt.eqUnion(jedd.internal.Jedd.v().replace(jedd.internal.Jedd.v().intersect(jedd.internal.Jedd.v().read(jedd.internal.Jedd.v().replace(propLoad(new jedd.internal.RelationContainer(new Attribute[] { fld.v(), base.v(), objc.v(), basec.v(), obj.v() },
