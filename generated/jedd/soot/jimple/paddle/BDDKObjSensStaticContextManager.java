    ...
    public boolean update() {
        final jedd.internal.RelationContainer newEdges =
          new jedd.internal.RelationContainer(new Attribute[] { srcc.v(), srcm.v(), stmt.v(), kind.v(), tgtc.v(), tgtm.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.srcc:soot.jimple.paddle.bdddo" +
                                               ...
                                               "arch/ccl/olhota/soot-trunk2/src/soot/jimple/paddle/BDDKObjSe" +
                                               "nsStaticContextManager.jedd:37,45-53"),
        ...
        out.add(new jedd.internal.RelationContainer(new Attribute[] { stmt.v(), tgtm.v(), srcm.v(), tgtc.v(), kind.v(), srcc.v() },
                                                    ...
                                                    ("out.add(newEdges) at /home/research/ccl/olhota/soot-trunk2/s" +
                                                     "rc/soot/jimple/paddle/BDDKObjSensStaticContextManager.jedd:3" +
                                                     "9,8-11"),
                                                    newEdges));
