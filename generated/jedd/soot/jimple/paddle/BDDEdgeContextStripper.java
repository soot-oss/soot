...
public class BDDEdgeContextStripper extends AbsEdgeContextStripper {
    ...
    boolean update() {
        ...
        out.add(new jedd.internal.RelationContainer(new jedd.Attribute[] { stmt.v(), tgtm.v(), srcm.v(), kind.v(), tgtc.v(), srcc.v() },
                                                    new jedd.PhysicalDomain[] { ST.v(), MT.v(), MS.v(), KD.v(), C2.v(), C1.v() },
