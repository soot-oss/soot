...
public class BDDInsensitiveVirtualContextManager extends AbsVirtualContextManager {
    ...
    public void update() {
        out.add(new jedd.internal.RelationContainer(new jedd.Attribute[] { stmt.v(), srcm.v(), kind.v(), tgtm.v(), tgtc.v(), srcc.v() },
                                                    new jedd.PhysicalDomain[] { ST.v(), T1.v(), FD.v(), T2.v(), V2.v(), V1.v() },
