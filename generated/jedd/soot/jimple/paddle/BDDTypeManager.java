...
public class BDDTypeManager extends AbsTypeManager {
    ...
    public void update() {
        ...
        final jedd.internal.RelationContainer newObjs =
          new jedd.internal.RelationContainer(new Attribute[] { obj.v(), type.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.obj:soot.jimple.paddle.bdddom" +
                                               ...
                                               "le.bdddomains.T2> newObjs; at /home/olhotak/soot-trunk2/src/" +
                                               "soot/jimple/paddle/BDDTypeManager.jedd:51,20-27"));
        newObjs.eq(jedd.internal.Jedd.v().project(localallocs.get(), new PhysicalDomain[] { T1.v() }));
        ...
        final jedd.internal.RelationContainer subtypeRelation =
          new jedd.internal.RelationContainer(new Attribute[] { subt.v(), supt.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.subt:soot.jimple.paddle.bdddo" +
                                               ...
                                               "nager.jedd:56,21-36"),
                                              fh.subtypeRelation());
        result.eqUnion(jedd.internal.Jedd.v().replace(jedd.internal.Jedd.v().compose(jedd.internal.Jedd.v().read(jedd.internal.Jedd.v().compose(jedd.internal.Jedd.v().read(subtypeRelation),
                                                                                                                                                newVars,
                                                                                                                                                new PhysicalDomain[] { T2.v() })),
                                                                                     allObjs,
                                                                                     new PhysicalDomain[] { T1.v() }),
        ...
        result.eqUnion(jedd.internal.Jedd.v().replace(jedd.internal.Jedd.v().compose(jedd.internal.Jedd.v().read(jedd.internal.Jedd.v().replace(jedd.internal.Jedd.v().compose(jedd.internal.Jedd.v().read(subtypeRelation),
                                                                                                                                                                               allVars,
                                                                                                                                                                               new PhysicalDomain[] { T2.v() }),
                                                                                                                                                new PhysicalDomain[] { T1.v() },
                                                                                                                                                new PhysicalDomain[] { T2.v() })),
    ...
    public jedd.internal.RelationContainer get() {
        ...
        return new jedd.internal.RelationContainer(new Attribute[] { var.v(), obj.v() },
                                                   new PhysicalDomain[] { V2.v(), H1.v() },
                                                   ("return result; at /home/olhotak/soot-trunk2/src/soot/jimple/" +
                                                    "paddle/BDDTypeManager.jedd:65,8-14"),
                                                   result);
    }
