...
public class BDDPAG extends AbsPAG {
    ...
    public void update() {
        final jedd.internal.RelationContainer newSimple =
          new jedd.internal.RelationContainer(new Attribute[] { src.v(), dst.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.src:soot.jimple.paddle.bdddom" +
                                               ...
                                               "dd.internal.Jedd.v().read(simple.get()), simpleBDD); at /tmp" +
                                               "/soot-trunk/src/soot/jimple/paddle/BDDPAG.jedd:44,19-28"),
        ...
        simpleout.add(new jedd.internal.RelationContainer(new Attribute[] { dst.v(), src.v() },
                                                          ...
                                                          ("simpleout.add(newSimple) at /tmp/soot-trunk/src/soot/jimple/" +
                                                           "paddle/BDDPAG.jedd:45,8-17"),
                                                          newSimple));
        ...
        final jedd.internal.RelationContainer newAlloc =
          new jedd.internal.RelationContainer(new Attribute[] { obj.v(), var.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.obj:soot.jimple.paddle.bdddom" +
                                               ...
                                               "d.internal.Jedd.v().read(alloc.get()), allocBDD); at /tmp/so" +
                                               "ot-trunk/src/soot/jimple/paddle/BDDPAG.jedd:48,19-27"),
                                              jedd.internal.Jedd.v().minus(jedd.internal.Jedd.v().read(alloc.get()),
                                                                           allocBDD));
        allocout.add(new jedd.internal.RelationContainer(new Attribute[] { obj.v(), var.v() },
                                                         new PhysicalDomain[] { H1.v(), V1.v() },
                                                         ("allocout.add(newAlloc) at /tmp/soot-trunk/src/soot/jimple/pa" +
                                                          "ddle/BDDPAG.jedd:49,8-16"),
                                                         newAlloc));
        ...
        final jedd.internal.RelationContainer newLoad =
          new jedd.internal.RelationContainer(new Attribute[] { src.v(), fld.v(), dst.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.src:soot.jimple.paddle.bdddom" +
                                               ...
                                               "nus(jedd.internal.Jedd.v().read(load.get()), loadBDD); at /t" +
                                               "mp/soot-trunk/src/soot/jimple/paddle/BDDPAG.jedd:52,24-31"),
        ...
        loadout.add(new jedd.internal.RelationContainer(new Attribute[] { fld.v(), dst.v(), src.v() },
                                                        ...
                                                        ("loadout.add(newLoad) at /tmp/soot-trunk/src/soot/jimple/padd" +
                                                         "le/BDDPAG.jedd:53,8-15"),
                                                        newLoad));
        ...
        final jedd.internal.RelationContainer newStore =
          new jedd.internal.RelationContainer(new Attribute[] { src.v(), fld.v(), dst.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.src:soot.jimple.paddle.bdddom" +
                                               ...
                                               " /tmp/soot-trunk/src/soot/jimple/paddle/BDDPAG.jedd:56,24-32"),
        ...
        storeout.add(new jedd.internal.RelationContainer(new Attribute[] { fld.v(), dst.v(), src.v() },
                                                         new PhysicalDomain[] { FD.v(), V2.v(), V1.v() },
                                                         ("storeout.add(newStore) at /tmp/soot-trunk/src/soot/jimple/pa" +
                                                          "ddle/BDDPAG.jedd:57,8-16"),
                                                         newStore));
    ...
    public Iterator simpleSources() {
        return new jedd.internal.RelationContainer(new Attribute[] { src.v() },
                                                   ...
                                                   ("jedd.internal.Jedd.v().project(simpleBDD, new jedd.PhysicalD" +
                                                    "omain[...]).iterator() at /tmp/soot-trunk/src/soot/jimple/pa" +
                                                    "ddle/BDDPAG.jedd:62,35-43"),
    ...
    public Iterator loadSources() {
        return new FieldRefIterator(new jedd.internal.RelationContainer(new Attribute[] { fld.v(), var.v() },
                                                                        ...
                                                                        ("new soot.jimple.paddle.BDDPAG.FieldRefIterator(...) at /tmp/" +
                                                                         "soot-trunk/src/soot/jimple/paddle/BDDPAG.jedd:65,15-18"),
    ...
    public Iterator storeSources() {
        return new jedd.internal.RelationContainer(new Attribute[] { src.v() },
                                                   ...
                                                   ("jedd.internal.Jedd.v().project(storeBDD, new jedd.PhysicalDo" +
                                                    "main[...]).iterator() at /tmp/soot-trunk/src/soot/jimple/pad" +
                                                    "dle/BDDPAG.jedd:68,42-50"),
    ...
    public Iterator loadInvSources() {
        return new jedd.internal.RelationContainer(new Attribute[] { dst.v() },
                                                   ...
                                                   ("jedd.internal.Jedd.v().project(loadBDD, new jedd.PhysicalDom" +
                                                    "ain[...]).iterator() at /tmp/soot-trunk/src/soot/jimple/padd" +
                                                    "le/BDDPAG.jedd:77,40-48"),
    ...
    public Iterator storeInvSources() {
        return new FieldRefIterator(new jedd.internal.RelationContainer(new Attribute[] { fld.v(), var.v() },
                                                                        new PhysicalDomain[] { FD.v(), V2.v() },
                                                                        ("new soot.jimple.paddle.BDDPAG.FieldRefIterator(...) at /tmp/" +
                                                                         "soot-trunk/src/soot/jimple/paddle/BDDPAG.jedd:80,15-18"),
                                                                        jedd.internal.Jedd.v().project(storeBDD,
                                                                                                       new PhysicalDomain[] { V1.v() })));
    }
    ...
    public Iterator simpleLookup(VarNode key) {
        return new jedd.internal.RelationContainer(new Attribute[] { dst.v() },
                                                   ...
                                                   ("jedd.internal.Jedd.v().compose(jedd.internal.Jedd.v().read(s" +
                                                    ...
                                                    ".]), new jedd.PhysicalDomain[...]).iterator() at /tmp/soot-t" +
                                                    "runk/src/soot/jimple/paddle/BDDPAG.jedd:87,55-63"),
    ...
    public Iterator loadLookup(FieldRefNode key) {
        return new jedd.internal.RelationContainer(new Attribute[] { dst.v() },
                                                   ...
                                                   ("jedd.internal.Jedd.v().compose(jedd.internal.Jedd.v().read(l" +
                                                    ...
                                                    "), new jedd.PhysicalDomain[...]).iterator() at /tmp/soot-tru" +
                                                    "nk/src/soot/jimple/paddle/BDDPAG.jedd:91,69-77"),
    ...
    public Iterator storeLookup(VarNode key) {
        return new FieldRefIterator(new jedd.internal.RelationContainer(new Attribute[] { fld.v(), var.v() },
                                                                        new PhysicalDomain[] { FD.v(), V2.v() },
                                                                        ("new soot.jimple.paddle.BDDPAG.FieldRefIterator(...) at /tmp/" +
                                                                         "soot-trunk/src/soot/jimple/paddle/BDDPAG.jedd:94,15-18"),
    ...
    public Iterator allocLookup(AllocNode key) {
        return new jedd.internal.RelationContainer(new Attribute[] { var.v() },
                                                   ...
                                                   ("jedd.internal.Jedd.v().compose(jedd.internal.Jedd.v().read(a" +
                                                    ...
                                                    "]), new jedd.PhysicalDomain[...]).iterator() at /tmp/soot-tr" +
                                                    "unk/src/soot/jimple/paddle/BDDPAG.jedd:98,54-62"),
    ...
    public Iterator simpleInvLookup(VarNode key) {
        return new jedd.internal.RelationContainer(new Attribute[] { src.v() },
                                                   ...
                                                   ("jedd.internal.Jedd.v().compose(jedd.internal.Jedd.v().read(s" +
                                                    ...
                                                    "ct[...], new jedd.Attribute[...], new jedd.PhysicalDomain[.." +
                                                    ".]), new jedd.PhysicalDomain[...]).iterator() at /tmp/soot-t" +
                                                    "runk/src/soot/jimple/paddle/BDDPAG.jedd:101,55-63"),
                                                   jedd.internal.Jedd.v().compose(jedd.internal.Jedd.v().read(simpleBDD),
                                                                                  jedd.internal.Jedd.v().literal(new Object[] { key },
                                                                                                                 new Attribute[] { dst.v() },
                                                                                                                 new PhysicalDomain[] { V2.v() }),
    ...
    public Iterator loadInvLookup(VarNode key) {
        return new FieldRefIterator(new jedd.internal.RelationContainer(new Attribute[] { fld.v(), var.v() },
                                                                        new PhysicalDomain[] { FD.v(), V2.v() },
                                                                        ("new soot.jimple.paddle.BDDPAG.FieldRefIterator(...) at /tmp/" +
                                                                         "soot-trunk/src/soot/jimple/paddle/BDDPAG.jedd:104,15-18"),
    ...
    public Iterator storeInvLookup(FieldRefNode key) {
        return new jedd.internal.RelationContainer(new Attribute[] { src.v() },
                                                   ...
                                                   ("jedd.internal.Jedd.v().compose(jedd.internal.Jedd.v().read(s" +
                                                    ...
                                                    "t[...], new jedd.Attribute[...], new jedd.PhysicalDomain[..." +
                                                    "]), new jedd.PhysicalDomain[...]).iterator() at /tmp/soot-tr" +
                                                    "unk/src/soot/jimple/paddle/BDDPAG.jedd:109,69-77"),
                                                   jedd.internal.Jedd.v().compose(jedd.internal.Jedd.v().read(storeBDD),
                                                                                  jedd.internal.Jedd.v().literal(new Object[] { key.getBase(), key.getField() },
    ...
    public Iterator allocInvLookup(VarNode key) {
        return new jedd.internal.RelationContainer(new Attribute[] { obj.v() },
                                                   ...
                                                   ("jedd.internal.Jedd.v().compose(jedd.internal.Jedd.v().read(a" +
                                                    ...
                                                    "t[...], new jedd.Attribute[...], new jedd.PhysicalDomain[..." +
                                                    "]), new jedd.PhysicalDomain[...]).iterator() at /tmp/soot-tr" +
                                                    "unk/src/soot/jimple/paddle/BDDPAG.jedd:112,54-62"),
                                                   jedd.internal.Jedd.v().compose(jedd.internal.Jedd.v().read(allocBDD),
                                                                                  jedd.internal.Jedd.v().literal(new Object[] { key },
                                                                                                                 new Attribute[] { var.v() },
                                                                                                                 new PhysicalDomain[] { V1.v() }),
    ...
    public Rsrc_dst allSimple() {
        return new Rsrc_dstBDD(new jedd.internal.RelationContainer(new Attribute[] { dst.v(), src.v() },
                                                                   new PhysicalDomain[] { V2.v(), V1.v() },
                                                                   ("new soot.jimple.paddle.queue.Rsrc_dstBDD(...) at /tmp/soot-t" +
                                                                    "runk/src/soot/jimple/paddle/BDDPAG.jedd:115,41-44"),
                                                                   simpleBDD));
    }
    ...
    public Rsrc_fld_dst allLoad() {
        return new Rsrc_fld_dstBDD(new jedd.internal.RelationContainer(new Attribute[] { fld.v(), dst.v(), src.v() },
                                                                       new PhysicalDomain[] { FD.v(), V2.v(), V1.v() },
                                                                       ("new soot.jimple.paddle.queue.Rsrc_fld_dstBDD(...) at /tmp/so" +
                                                                        "ot-trunk/src/soot/jimple/paddle/BDDPAG.jedd:116,43-46"),
                                                                       loadBDD));
    }
    ...
    public Rsrc_fld_dst allStore() {
        return new Rsrc_fld_dstBDD(new jedd.internal.RelationContainer(new Attribute[] { fld.v(), dst.v(), src.v() },
                                                                       new PhysicalDomain[] { FD.v(), V2.v(), V1.v() },
                                                                       ("new soot.jimple.paddle.queue.Rsrc_fld_dstBDD(...) at /tmp/so" +
                                                                        "ot-trunk/src/soot/jimple/paddle/BDDPAG.jedd:117,44-47"),
                                                                       storeBDD));
    }
    
    public Robj_var allAlloc() {
        return new Robj_varBDD(new jedd.internal.RelationContainer(new Attribute[] { obj.v(), var.v() },
                                                                   new PhysicalDomain[] { H1.v(), V1.v() },
                                                                   ("new soot.jimple.paddle.queue.Robj_varBDD(...) at /tmp/soot-t" +
                                                                    "runk/src/soot/jimple/paddle/BDDPAG.jedd:118,40-43"),
                                                                   allocBDD));
    }
            ...
            this.it =
              new jedd.internal.RelationContainer(new Attribute[] { fld.v(), var.v() },
                                                  ...
                                                  ("bdd.iterator(new jedd.Attribute[...]) at /tmp/soot-trunk/src" +
                                                   "/soot/jimple/paddle/BDDPAG.jedd:122,22-25"),
    ...
    private final jedd.internal.RelationContainer simpleBDD =
      new jedd.internal.RelationContainer(new Attribute[] { src.v(), dst.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.src, soot.jimple.padd" +
                                           ...
                                           "DD() at /tmp/soot-trunk/src/soot/jimple/paddle/BDDPAG.jedd:1" +
                                           "33,12-22"),
    ...
    private final jedd.internal.RelationContainer loadBDD =
      new jedd.internal.RelationContainer(new Attribute[] { src.v(), fld.v(), dst.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.src, soot.jimple.padd" +
                                           ...
                                           "D = jedd.internal.Jedd.v().falseBDD() at /tmp/soot-trunk/src" +
                                           "/soot/jimple/paddle/BDDPAG.jedd:134,12-27"),
                                          jedd.internal.Jedd.v().falseBDD());
    ...
    private final jedd.internal.RelationContainer storeBDD =
      new jedd.internal.RelationContainer(new Attribute[] { src.v(), fld.v(), dst.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.src, soot.jimple.padd" +
                                           ...
                                           "DD = jedd.internal.Jedd.v().falseBDD() at /tmp/soot-trunk/sr" +
                                           "c/soot/jimple/paddle/BDDPAG.jedd:135,12-27"),
                                          jedd.internal.Jedd.v().falseBDD());
    ...
    private final jedd.internal.RelationContainer allocBDD =
      new jedd.internal.RelationContainer(new Attribute[] { obj.v(), var.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.obj, soot.jimple.padd" +
                                           ...
                                           "D() at /tmp/soot-trunk/src/soot/jimple/paddle/BDDPAG.jedd:13" +
                                           "6,12-22"),
                                          jedd.internal.Jedd.v().falseBDD());
}
