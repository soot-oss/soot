...
public class BDDPAG extends AbsPAG {
    ...
    public Rsrcc_src_dstc_dst allSimple() {
        return new Rsrcc_src_dstc_dstBDD(new jedd.internal.RelationContainer(new Attribute[] { src.v(), dst.v(), dstc.v(), srcc.v() },
    ...
    public Rsrcc_src_fld_dstc_dst allLoad() {
        return new Rsrcc_src_fld_dstc_dstBDD(new jedd.internal.RelationContainer(new Attribute[] { fld.v(), src.v(), dst.v(), dstc.v(), srcc.v() },
    ...
    public Rsrcc_src_dstc_dst_fld allStore() {
        return new Rsrcc_src_dstc_dst_fldBDD(new jedd.internal.RelationContainer(new Attribute[] { fld.v(), src.v(), dst.v(), dstc.v(), srcc.v() },
                                                                                 new PhysicalDomain[] { FD.v(), V1.v(), V2.v(), C2.v(), C1.v() },
    ...
    public Robjc_obj_varc_var allAlloc() {
        return new Robjc_obj_varc_varBDD(new jedd.internal.RelationContainer(new Attribute[] { objc.v(), varc.v(), var.v(), obj.v() },
