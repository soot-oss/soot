...
public class BDDCallGraph extends AbsCallGraph {
    private final jedd.internal.RelationContainer edges =
      new jedd.internal.RelationContainer(new jedd.Attribute[] { srcc.v(), srcm.v(), stmt.v(), kind.v(), tgtc.v(), tgtm.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.srcc, soot.jimple.pad" +
                                           ...
                                           "ns.tgtc, soot.jimple.paddle.bdddomains.tgtm> edges at /tmp/s" +
                                           "oot-trunk-saved/src/soot/jimple/paddle/BDDCallGraph.jedd:30," +
                                           "12-48"));
    ...
    public boolean update() {
        final jedd.internal.RelationContainer newEdges =
          new jedd.internal.RelationContainer(new jedd.Attribute[] { srcc.v(), srcm.v(), stmt.v(), kind.v(), tgtc.v(), tgtm.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.srcc:soot.jimple.paddle.bdddo" +
                                               ...
                                               "ges = in.get(); at /tmp/soot-trunk-saved/src/soot/jimple/pad" +
                                               "dle/BDDCallGraph.jedd:35,45-53"),
                                              in.get());
        ...
        out.add(new jedd.internal.RelationContainer(new jedd.Attribute[] { tgtm.v(), srcc.v(), tgtc.v(), stmt.v(), srcm.v(), kind.v() },
                                                    ...
                                                    ("out.add(newEdges) at /tmp/soot-trunk-saved/src/soot/jimple/p" +
                                                     "addle/BDDCallGraph.jedd:38,8-11"),
                                                    newEdges));
    ...
    public Rsrcc_srcm_stmt_kind_tgtc_tgtm edgesOutOf(Rctxt_method methods) {
        return new Rsrcc_srcm_stmt_kind_tgtc_tgtmBDD(new jedd.internal.RelationContainer(new jedd.Attribute[] { tgtm.v(), srcc.v(), stmt.v(), tgtc.v(), srcm.v(), kind.v() },
                                                                                         new jedd.PhysicalDomain[] { MT.v(), C1.v(), ST.v(), C2.v(), MS.v(), KD.v() },
                                                                                         ("new soot.jimple.paddle.queue.Rsrcc_srcm_stmt_kind_tgtc_tgtmB" +
                                                                                          "DD(...) at /tmp/soot-trunk-saved/src/soot/jimple/paddle/BDDC" +
                                                                                          "allGraph.jedd:42,15-18"),
    ...
    public Rsrcc_srcm_stmt_kind_tgtc_tgtm edges() {
        return new Rsrcc_srcm_stmt_kind_tgtc_tgtmBDD(new jedd.internal.RelationContainer(new jedd.Attribute[] { tgtm.v(), srcc.v(), tgtc.v(), stmt.v(), srcm.v(), kind.v() },
                                                                                         new jedd.PhysicalDomain[] { MT.v(), C1.v(), C2.v(), ST.v(), MS.v(), KD.v() },
                                                                                         ("new soot.jimple.paddle.queue.Rsrcc_srcm_stmt_kind_tgtc_tgtmB" +
                                                                                          "DD(...) at /tmp/soot-trunk-saved/src/soot/jimple/paddle/BDDC" +
                                                                                          "allGraph.jedd:54,15-18"),
                                                                                         edges),
                                                     "edges");
    }
    ...
    public int size() {
        return (int)
                 new jedd.internal.RelationContainer(new jedd.Attribute[] { tgtm.v(), srcc.v(), tgtc.v(), stmt.v(), srcm.v(), kind.v() },
                                                     new jedd.PhysicalDomain[] { MT.v(), C1.v(), C2.v(), ST.v(), MS.v(), KD.v() },
                                                     ("edges.size() at /tmp/soot-trunk-saved/src/soot/jimple/paddle" +
                                                      "/BDDCallGraph.jedd:57,21-26"),
                                                     edges).size();
    }
}
