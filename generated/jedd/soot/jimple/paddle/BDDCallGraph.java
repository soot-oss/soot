...
public class BDDCallGraph extends AbsCallGraph {
    ...
    public boolean update() {
        ...
        out.add(new jedd.internal.RelationContainer(new jedd.Attribute[] { stmt.v(), srcm.v(), tgtc.v(), kind.v(), tgtm.v(), srcc.v() },
                                                    new jedd.PhysicalDomain[] { ST.v(), T1.v(), V2.v(), FD.v(), T2.v(), V1.v() },
                                                    ("out.add(edges) at /home/olhotak/soot-trunk/src/soot/jimple/p" +
    ...
    public Rsrcc_srcm_stmt_kind_tgtc_tgtm edgesOutOf(Rctxt_method methods) {
        return new Rsrcc_srcm_stmt_kind_tgtc_tgtmBDD(new jedd.internal.RelationContainer(new jedd.Attribute[] { stmt.v(), srcm.v(), tgtc.v(), kind.v(), tgtm.v(), srcc.v() },
                                                                                         new jedd.PhysicalDomain[] { ST.v(), T1.v(), V2.v(), FD.v(), T2.v(), V1.v() },
