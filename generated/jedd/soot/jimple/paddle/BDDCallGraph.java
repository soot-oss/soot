...
public class BDDCallGraph extends AbsCallGraph {
    private final jedd.internal.RelationContainer edges =
      new jedd.internal.RelationContainer(new jedd.Attribute[] { srcc.v(), srcm.v(), stmt.v(), kind.v(), tgtc.v(), tgtm.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.srcc, soot.jimple.pad" +
                                           ...
                                           "research/ccl/olhota/soot-trunk2/src/soot/jimple/paddle/BDDCa" +
                                           "llGraph.jedd:30,12-48"));
    ...
    public boolean update() {
        final jedd.internal.RelationContainer newEdges =
          new jedd.internal.RelationContainer(new jedd.Attribute[] { srcc.v(), srcm.v(), stmt.v(), kind.v(), tgtc.v(), tgtm.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.srcc:soot.jimple.paddle.bdddo" +
                                               ...
                                               "ges = in.get(); at /home/research/ccl/olhota/soot-trunk2/src" +
        ...
        out.add(new jedd.internal.RelationContainer(new jedd.Attribute[] { srcm.v(), stmt.v(), tgtm.v(), tgtc.v(), kind.v(), srcc.v() },
                                                    ...
                                                    ("out.add(newEdges) at /home/research/ccl/olhota/soot-trunk2/s" +
                                                     "rc/soot/jimple/paddle/BDDCallGraph.jedd:38,8-11"),
                                                    newEdges));
    ...
    public Rsrcc_srcm_stmt_kind_tgtc_tgtm edgesOutOf(Rctxt_method methods) {
        return new Rsrcc_srcm_stmt_kind_tgtc_tgtmBDD(new jedd.internal.RelationContainer(new jedd.Attribute[] { srcm.v(), stmt.v(), tgtm.v(), tgtc.v(), srcc.v(), kind.v() },
                                                                                         new jedd.PhysicalDomain[] { MS.v(), ST.v(), MT.v(), C2.v(), C1.v(), KD.v() },
                                                                                         ("new soot.jimple.paddle.queue.Rsrcc_srcm_stmt_kind_tgtc_tgtmB" +
                                                                                          "DD(...) at /home/research/ccl/olhota/soot-trunk2/src/soot/ji" +
                                                                                          "mple/paddle/BDDCallGraph.jedd:42,15-18"),
    ...
    public Rsrcc_srcm_stmt_kind_tgtc_tgtm edgesOutOf(MethodOrMethodContext m) {
        return new Rsrcc_srcm_stmt_kind_tgtc_tgtmBDD(new jedd.internal.RelationContainer(new jedd.Attribute[] { srcm.v(), stmt.v(), tgtm.v(), tgtc.v(), srcc.v(), kind.v() },
                                                                                         ...
                                                                                         ("new soot.jimple.paddle.queue.Rsrcc_srcm_stmt_kind_tgtc_tgtmB" +
                                                                                          "DD(...) at /home/research/ccl/olhota/soot-trunk2/src/soot/ji" +
                                                                                          "mple/paddle/BDDCallGraph.jedd:47,15-18"),
                                                                                         jedd.internal.Jedd.v().join(jedd.internal.Jedd.v().read(edges),
    ...
    public Rsrcc_srcm_stmt_kind_tgtc_tgtm edges() {
        return new Rsrcc_srcm_stmt_kind_tgtc_tgtmBDD(new jedd.internal.RelationContainer(new jedd.Attribute[] { srcm.v(), stmt.v(), tgtm.v(), tgtc.v(), kind.v(), srcc.v() },
                                                                                         new jedd.PhysicalDomain[] { MS.v(), ST.v(), MT.v(), C2.v(), KD.v(), C1.v() },
                                                                                         ("new soot.jimple.paddle.queue.Rsrcc_srcm_stmt_kind_tgtc_tgtmB" +
                                                                                          "DD(...) at /home/research/ccl/olhota/soot-trunk2/src/soot/ji" +
                                                                                          "mple/paddle/BDDCallGraph.jedd:54,15-18"),
                                                                                         edges),
                                                     "edges");
    }
    ...
    public int size() {
        return (int)
                 new jedd.internal.RelationContainer(new jedd.Attribute[] { srcm.v(), stmt.v(), tgtm.v(), tgtc.v(), kind.v(), srcc.v() },
                                                     new jedd.PhysicalDomain[] { MS.v(), ST.v(), MT.v(), C2.v(), KD.v(), C1.v() },
                                                     ("edges.size() at /home/research/ccl/olhota/soot-trunk2/src/so" +
                                                      "ot/jimple/paddle/BDDCallGraph.jedd:57,21-26"),
                                                     edges).size();
    }
}
