...
public class BDDCallGraph extends AbsCallGraph {
    ...
    public boolean update() {
        final jedd.internal.RelationContainer newEdges =
          new jedd.internal.RelationContainer(new jedd.Attribute[] { srcc.v(), srcm.v(), stmt.v(), kind.v(), tgtc.v(), tgtm.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.srcc:soot.jimple.paddle.bdddo" +
                                               ...
                                               "ges = in.get(); at /home/research/ccl/olhota/soot-jedd/src/s" +
                                               "oot/jimple/paddle/BDDCallGraph.jedd:35,45-53"),
                                              in.get());
        ...
        out.add(new jedd.internal.RelationContainer(new jedd.Attribute[] { tgtc.v(), tgtm.v(), srcc.v(), srcm.v(), kind.v(), stmt.v() },
                                                    ...
                                                    ("out.add(newEdges) at /home/research/ccl/olhota/soot-jedd/src" +
                                                     "/soot/jimple/paddle/BDDCallGraph.jedd:38,8-11"),
                                                    newEdges));
    ...
    public Rsrcc_srcm_stmt_kind_tgtc_tgtm edgesOutOf(Rctxt_method methods) {
        return new Rsrcc_srcm_stmt_kind_tgtc_tgtmBDD(new jedd.internal.RelationContainer(new jedd.Attribute[] { tgtc.v(), tgtm.v(), srcc.v(), srcm.v(), stmt.v(), kind.v() },
                                                                                         new jedd.PhysicalDomain[] { C2.v(), MT.v(), C1.v(), MS.v(), ST.v(), KD.v() },
                                                                                         ("new soot.jimple.paddle.queue.Rsrcc_srcm_stmt_kind_tgtc_tgtmB" +
                                                                                          "DD(...) at /home/research/ccl/olhota/soot-jedd/src/soot/jimp" +
                                                                                          "le/paddle/BDDCallGraph.jedd:42,15-18"),
    ...
    public Rsrcc_srcm_stmt_kind_tgtc_tgtm edgesOutOf(MethodOrMethodContext m) {
        return new Rsrcc_srcm_stmt_kind_tgtc_tgtmBDD(new jedd.internal.RelationContainer(new jedd.Attribute[] { tgtc.v(), tgtm.v(), srcc.v(), srcm.v(), stmt.v(), kind.v() },
                                                                                         ...
                                                                                         ("new soot.jimple.paddle.queue.Rsrcc_srcm_stmt_kind_tgtc_tgtmB" +
                                                                                          "DD(...) at /home/research/ccl/olhota/soot-jedd/src/soot/jimp" +
                                                                                          "le/paddle/BDDCallGraph.jedd:47,15-18"),
                                                                                         jedd.internal.Jedd.v().join(jedd.internal.Jedd.v().read(edges),
    ...
    public Rsrcc_srcm_stmt_kind_tgtc_tgtm edges() {
        return new Rsrcc_srcm_stmt_kind_tgtc_tgtmBDD(new jedd.internal.RelationContainer(new jedd.Attribute[] { tgtc.v(), tgtm.v(), srcc.v(), srcm.v(), kind.v(), stmt.v() },
                                                                                         new jedd.PhysicalDomain[] { C2.v(), MT.v(), C1.v(), MS.v(), KD.v(), ST.v() },
                                                                                         ("new soot.jimple.paddle.queue.Rsrcc_srcm_stmt_kind_tgtc_tgtmB" +
                                                                                          "DD(...) at /home/research/ccl/olhota/soot-jedd/src/soot/jimp" +
                                                                                          "le/paddle/BDDCallGraph.jedd:54,15-18"),
                                                                                         edges),
                                                     "edges");
    }
    ...
    public int size() {
        return (int)
                 new jedd.internal.RelationContainer(new jedd.Attribute[] { tgtc.v(), tgtm.v(), srcc.v(), srcm.v(), kind.v(), stmt.v() },
                                                     new jedd.PhysicalDomain[] { C2.v(), MT.v(), C1.v(), MS.v(), KD.v(), ST.v() },
                                                     ("edges.size() at /home/research/ccl/olhota/soot-jedd/src/soot" +
                                                      "/jimple/paddle/BDDCallGraph.jedd:57,21-26"),
                                                     edges).size();
    }
}
