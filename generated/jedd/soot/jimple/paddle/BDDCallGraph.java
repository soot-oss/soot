...
public class BDDCallGraph extends AbsCallGraph {
    ...
    public Rsrcc_srcm_stmt_kind_tgtc_tgtm edgesOutOf(Rctxt_method methods) {
        return new Rsrcc_srcm_stmt_kind_tgtc_tgtmBDD(new jedd.internal.RelationContainer(new jedd.Attribute[] { srcc.v(), kind.v(), tgtc.v(), srcm.v(), stmt.v(), tgtm.v() },
                                                                                         new jedd.PhysicalDomain[] { C1.v(), KD.v(), C2.v(), MS.v(), ST.v(), MT.v() },
    ...
    public int size() {
        return (int)
                 new jedd.internal.RelationContainer(new jedd.Attribute[] { srcc.v(), tgtc.v(), kind.v(), srcm.v(), stmt.v(), tgtm.v() },
                                                     new jedd.PhysicalDomain[] { C1.v(), C2.v(), KD.v(), MS.v(), ST.v(), MT.v() },
