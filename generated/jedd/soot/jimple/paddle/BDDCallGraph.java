...
public class BDDCallGraph extends AbsCallGraph {
    private final jedd.internal.RelationContainer edges =
      new jedd.internal.RelationContainer(new jedd.Attribute[] { srcc.v(), srcm.v(), stmt.v(), kind.v(), tgtc.v(), tgtm.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.srcc, soot.jimple.pad" +
                                           ...
                                           "olhotak/soot-trunk2/src/soot/jimple/paddle/BDDCallGraph.jedd" +
                                           ":30,12-48"));
    ...
    public boolean update() {
        final jedd.internal.RelationContainer newEdges =
          new jedd.internal.RelationContainer(new jedd.Attribute[] { srcc.v(), srcm.v(), stmt.v(), kind.v(), tgtc.v(), tgtm.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.srcc:soot.jimple.paddle.bdddo" +
                                               ...
                                               "ges = in.get(); at /home/olhotak/soot-trunk2/src/soot/jimple" +
        ...
        out.add(new jedd.internal.RelationContainer(new jedd.Attribute[] { srcc.v(), tgtc.v(), kind.v(), stmt.v(), srcm.v(), tgtm.v() },
                                                    ...
                                                    ("out.add(newEdges) at /home/olhotak/soot-trunk2/src/soot/jimp" +
                                                     "le/paddle/BDDCallGraph.jedd:38,8-11"),
                                                    newEdges));
    ...
    public Rsrcc_srcm_stmt_kind_tgtc_tgtm edgesOutOf(Rctxt_method methods) {
        return new Rsrcc_srcm_stmt_kind_tgtc_tgtmBDD(new jedd.internal.RelationContainer(new jedd.Attribute[] { srcc.v(), tgtc.v(), kind.v(), srcm.v(), stmt.v(), tgtm.v() },
                                                                                         new jedd.PhysicalDomain[] { V1.v(), V2.v(), FD.v(), T1.v(), ST.v(), T2.v() },
                                                                                         ("new soot.jimple.paddle.queue.Rsrcc_srcm_stmt_kind_tgtc_tgtmB" +
                                                                                          "DD(...) at /home/olhotak/soot-trunk2/src/soot/jimple/paddle/" +
                                                                                          "BDDCallGraph.jedd:42,15-18"),
    ...
    public Rsrcc_srcm_stmt_kind_tgtc_tgtm edges() {
        return new Rsrcc_srcm_stmt_kind_tgtc_tgtmBDD(new jedd.internal.RelationContainer(new jedd.Attribute[] { srcc.v(), tgtc.v(), kind.v(), stmt.v(), srcm.v(), tgtm.v() },
                                                                                         new jedd.PhysicalDomain[] { V1.v(), V2.v(), FD.v(), ST.v(), T1.v(), T2.v() },
                                                                                         ("new soot.jimple.paddle.queue.Rsrcc_srcm_stmt_kind_tgtc_tgtmB" +
                                                                                          "DD(...) at /home/olhotak/soot-trunk2/src/soot/jimple/paddle/" +
                                                                                          "BDDCallGraph.jedd:54,15-18"),
                                                                                         edges),
                                                     "edges");
    }
    ...
    public int size() {
        return (int)
                 new jedd.internal.RelationContainer(new jedd.Attribute[] { srcc.v(), tgtc.v(), kind.v(), stmt.v(), srcm.v(), tgtm.v() },
                                                     new jedd.PhysicalDomain[] { V1.v(), V2.v(), FD.v(), ST.v(), T1.v(), T2.v() },
                                                     ("edges.size() at /home/olhotak/soot-trunk2/src/soot/jimple/pa" +
                                                      "ddle/BDDCallGraph.jedd:57,21-26"),
                                                     edges).size();
    }
}
