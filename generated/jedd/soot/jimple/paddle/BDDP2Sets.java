...
public class BDDP2Sets extends AbsP2Sets {
    ...
    public PointsToSetReadOnly get(Context ctxt, VarNode v) {
        return new BDDPointsToSet(new jedd.internal.RelationContainer(new jedd.Attribute[] { obj.v(), objc.v() },
                                                                      ...
                                                                      jedd.internal.Jedd.v().replace(jedd.internal.Jedd.v().compose(jedd.internal.Jedd.v().read(jedd.internal.Jedd.v().replace(prop.pt,
    ...
    public Rvarc_var_objc_obj getReader(VarNode vn) {
        Rvarc_var_objc_objBDD ret =
          new Rvarc_var_objc_objBDD(new jedd.internal.RelationContainer(new jedd.Attribute[] { obj.v(), objc.v(), var.v(), varc.v() },
                                                                        ...
                                                                        ("new soot.jimple.paddle.queue.Rvarc_var_objc_objBDD(...) at /" +
                                                                         ...
                                                                         ":55,36-39"),
                                                                        jedd.internal.Jedd.v().join(jedd.internal.Jedd.v().read(jedd.internal.Jedd.v().replace(prop.pt,
                                                                                                                                                               new jedd.PhysicalDomain[] { H2.v(), C3.v(), V2.v(), C2.v() },
                                                                                                                                                               new jedd.PhysicalDomain[] { H1.v(), C2.v(), V1.v(), C1.v() })),
