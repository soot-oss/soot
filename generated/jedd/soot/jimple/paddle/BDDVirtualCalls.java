...
public class BDDVirtualCalls extends AbsVirtualCalls {
        ...
        final jedd.internal.RelationContainer newStatics =
          new jedd.internal.RelationContainer(new jedd.Attribute[] { srcc.v(), srcm.v(), stmt.v(), kind.v(), tgtc.v(), tgtm.v() },
                                              ...
                                              jedd.internal.Jedd.v().replace(jedd.internal.Jedd.v().join(jedd.internal.Jedd.v().read(jedd.internal.Jedd.v().compose(jedd.internal.Jedd.v().read(tgtMethods),
                                                                             ...
                                                                             new jedd.PhysicalDomain[] { V1.v() }));
        statics.add(new jedd.internal.RelationContainer(new jedd.Attribute[] { tgtc.v(), tgtm.v(), kind.v(), stmt.v(), srcc.v(), srcm.v() },
                                                        new jedd.PhysicalDomain[] { V2.v(), T2.v(), FD.v(), ST.v(), V1.v(), T1.v() },
    ...
    private void updateSpecials() {
        ...
        out.add(new jedd.internal.RelationContainer(new jedd.Attribute[] { obj.v(), tgtm.v(), stmt.v(), var.v(), ctxt.v(), srcm.v(), kind.v() },
                                                    new jedd.PhysicalDomain[] { H1.v(), T2.v(), ST.v(), V1.v(), V2.v(), T1.v(), FD.v() },
          ...
          new jedd.internal.RelationContainer(new jedd.Attribute[] { type.v(), signature.v() },
                                              ...
                                              jedd.internal.Jedd.v().compose(jedd.internal.Jedd.v().read(ptTypes),
                                                                             jedd.internal.Jedd.v().project(rcv,
                                                                                                            new jedd.PhysicalDomain[] { ST.v(), FD.v(), T1.v() }),
                                                                             new jedd.PhysicalDomain[] { V1.v() }));
        ...
        final jedd.internal.RelationContainer newVirtuals =
          new jedd.internal.RelationContainer(new jedd.Attribute[] { ctxt.v(), var.v(), obj.v(), srcm.v(), stmt.v(), kind.v(), tgtm.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.ctxt:soot.jimple.paddle.bdddo" +
                                               ...
                                               "ysicalDomain[...]); at /home/olhotak/soot-trunk/src/soot/jim" +
                                               "ple/paddle/BDDVirtualCalls.jedd:222,49-60"),
                                              jedd.internal.Jedd.v().project(jedd.internal.Jedd.v().join(jedd.internal.Jedd.v().read(jedd.internal.Jedd.v().replace(jedd.internal.Jedd.v().project(jedd.internal.Jedd.v().replace(varCtxtPt,
                                                                             ...
                                                                             new jedd.PhysicalDomain[] { T2.v() }));
        out.add(new jedd.internal.RelationContainer(new jedd.Attribute[] { obj.v(), tgtm.v(), kind.v(), stmt.v(), var.v(), srcm.v(), ctxt.v() },
                                                    new jedd.PhysicalDomain[] { H1.v(), T2.v(), FD.v(), ST.v(), V1.v(), T1.v(), V2.v() },
