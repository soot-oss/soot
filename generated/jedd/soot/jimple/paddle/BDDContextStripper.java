...
public class BDDContextStripper extends AbsContextStripper {
    ...
    public boolean update() {
        final jedd.internal.RelationContainer answer =
          new jedd.internal.RelationContainer(new jedd.Attribute[] { ctxt.v(), method.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.ctxt:soot.jimple.paddle.bdddo" +
                                               ...
                                               "]); at /tmp/soot-trunk-saved/src/soot/jimple/paddle/BDDConte" +
                                               "xtStripper.jedd:35,23-29"),
        ...
        out.add(new jedd.internal.RelationContainer(new jedd.Attribute[] { ctxt.v(), method.v() },
                                                    new jedd.PhysicalDomain[] { C1.v(), MS.v() },
                                                    ("out.add(answer) at /tmp/soot-trunk-saved/src/soot/jimple/pad" +
                                                     "dle/BDDContextStripper.jedd:36,8-11"),
                                                    answer));
