...
public class Rsrcc_var_objc_objDebug extends Rsrcc_var_objc_obj {
    protected Rsrcc_var_objc_objBDD bdd;
    
    protected Rsrcc_var_objc_objSet trad;
    
    public Rsrcc_var_objc_objDebug(Rsrcc_var_objc_objBDD bdd, Rsrcc_var_objc_objSet trad, String name) {
        super(name);
        this.bdd = bdd;
        this.trad = trad;
    }
