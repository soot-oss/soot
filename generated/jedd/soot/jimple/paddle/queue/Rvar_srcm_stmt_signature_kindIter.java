    ...
    public jedd.internal.RelationContainer get() {
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { var.v(), srcm.v(), stmt.v(), signature.v(), kind.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.var:soot.jimple.paddle.bdddom" +
                                               ...
                                               ".internal.Jedd.v().falseBDD(); at /tmp/soot-trunk-saved/src/" +
                                               "soot/jimple/paddle/queue/Rvar_srcm_stmt_signature_kindIter.j" +
                                               "edd:46,58-61"),
        ...
        return new jedd.internal.RelationContainer(new Attribute[] { var.v(), signature.v(), stmt.v(), srcm.v(), kind.v() },
                                                   ...
                                                   ("return ret; at /tmp/soot-trunk-saved/src/soot/jimple/paddle/" +
                                                    "queue/Rvar_srcm_stmt_signature_kindIter.jedd:50,8-14"),
                                                   ret);
    }
