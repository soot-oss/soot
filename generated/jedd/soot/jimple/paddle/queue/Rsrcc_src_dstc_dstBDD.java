...
public final class Rsrcc_src_dstc_dstBDD extends Rsrcc_src_dstc_dst {
    ...
    public Rsrcc_src_dstc_dstBDD(final jedd.internal.RelationContainer bdd, String name) {
        this(name);
        add(new jedd.internal.RelationContainer(new Attribute[] { dstc.v(), srcc.v(), dst.v(), src.v() },
                                                new PhysicalDomain[] { C2.v(), C1.v(), V2.v(), V1.v() },
                                                ("add(bdd) at /home/olhotak/soot-trunk/src/soot/jimple/paddle/" +
                                                 "queue/Rsrcc_src_dstc_dstBDD.jedd:33,102-105"),
                                                bdd));
    }
        ...
        return new Iterator() {
            ...
            public Object next() {
                if (it == null || !it.hasNext()) {
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { dstc.v(), srcc.v(), dst.v(), src.v() },
                                                          new PhysicalDomain[] { C2.v(), C1.v(), V2.v(), V1.v() },
