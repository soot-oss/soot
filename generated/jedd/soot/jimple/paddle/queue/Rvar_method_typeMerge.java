...
public final class Rvar_method_typeMerge extends Rvar_method_type {
    void add(final jedd.internal.RelationContainer tuple) { throw new RuntimeException(); }
    
    private Rvar_method_type in1;
    
    private Rvar_method_type in2;
    
    public Rvar_method_typeMerge(Rvar_method_type in1, Rvar_method_type in2) {
    ...
    public jedd.internal.RelationContainer get() {
        return new jedd.internal.RelationContainer(new Attribute[] { type.v(), var.v(), method.v() },
                                                   ...
                                                   ("return jedd.internal.Jedd.v().union(jedd.internal.Jedd.v().r" +
                                                    ...
                                                    "soot/jimple/paddle/queue/Rvar_method_typeMerge.jedd:52,8-14"),
