...
public final class Qsrcm_stmt_kind_tgtm_src_dstSet extends Qsrcm_stmt_kind_tgtm_src_dst {
    ...
    public Rsrcm_stmt_kind_tgtm_src_dst reader(String rname) {
        Rsrcm_stmt_kind_tgtm_src_dst ret = new Rsrcm_stmt_kind_tgtm_src_dstSet(name + ":" + rname);
        readers.add(ret);
        return ret;
    }
    
    public Rsrcm_stmt_kind_tgtm_src_dst revreader(String rname) {
        Rsrcm_stmt_kind_tgtm_src_dst ret = new Rsrcm_stmt_kind_tgtm_src_dstRev(name + ":" + rname);
        readers.add(ret);
        return ret;
    }
}
