...
public final class Rsrcc_src_fld_dstc_dstBDD extends Rsrcc_src_fld_dstc_dst {
    ...
    public Rsrcc_src_fld_dstc_dstBDD(final jedd.internal.RelationContainer bdd, String name) {
        this(name);
        add(new jedd.internal.RelationContainer(new Attribute[] { dstc.v(), srcc.v(), fld.v(), dst.v(), src.v() },
                                                new PhysicalDomain[] { C2.v(), C1.v(), FD.v(), V2.v(), V1.v() },
                                                ("add(bdd) at /home/olhotak/soot-trunk/src/soot/jimple/paddle/" +
                                                 "queue/Rsrcc_src_fld_dstc_dstBDD.jedd:33,114-117"),
                                                bdd));
    }
    ...
    public jedd.internal.RelationContainer get() {
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { srcc.v(), src.v(), fld.v(), dstc.v(), dst.v() },
                                              ...
                                              bdd);
        bdd.eq(jedd.internal.Jedd.v().falseBDD());
        return new jedd.internal.RelationContainer(new Attribute[] { dstc.v(), srcc.v(), fld.v(), dst.v(), src.v() },
                                                   new PhysicalDomain[] { C2.v(), C1.v(), FD.v(), V2.v(), V1.v() },
