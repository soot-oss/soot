    ...
    private final jedd.internal.RelationContainer bdd =
      new jedd.internal.RelationContainer(new Attribute[] { srcc.v(), src.v(), fld.v(), dstc.v(), dst.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.srcc:soot.jimple.padd" +
                                           ...
                                           "ome/olhotak/soot-trunk/src/soot/jimple/paddle/queue/Rsrcc_sr" +
                                           "c_fld_dstc_dstBDD.jedd:31,12-54"));
    
    void add(final jedd.internal.RelationContainer tuple) { bdd.eqUnion(tuple); }
    
    public Rsrcc_src_fld_dstc_dstBDD(final jedd.internal.RelationContainer bdd, String name) {
        this(name);
        this.add(new jedd.internal.RelationContainer(new Attribute[] { fld.v(), dstc.v(), srcc.v(), dst.v(), src.v() },
                                                     new PhysicalDomain[] { FD.v(), C2.v(), C1.v(), V2.v(), V1.v() },
                                                     ("this.add(bdd) at /home/olhotak/soot-trunk/src/soot/jimple/pa" +
                                                      "ddle/queue/Rsrcc_src_fld_dstc_dstBDD.jedd:33,114-117"),
                                                     bdd));
    }
        ...
        return new Iterator() {
            ...
            public Object next() {
                if (it == null || !it.hasNext()) {
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { fld.v(), dstc.v(), srcc.v(), dst.v(), src.v() },
                                                          new PhysicalDomain[] { FD.v(), C2.v(), C1.v(), V2.v(), V1.v() },
                                                          ("bdd.iterator(new jedd.Attribute[...]) at /home/olhotak/soot-" +
                                                           "trunk/src/soot/jimple/paddle/queue/Rsrcc_src_fld_dstc_dstBDD" +
                                                           ".jedd:45,25-28"),
        ...
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { srcc.v(), src.v(), fld.v(), dstc.v(), dst.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.srcc:soot.jimple.paddle.bdddo" +
                                               ...
                                               "me/olhotak/soot-trunk/src/soot/jimple/paddle/queue/Rsrcc_src" +
                                               "_fld_dstc_dstBDD.jedd:55,51-54"),
                                              bdd);
        bdd.eq(jedd.internal.Jedd.v().falseBDD());
        return new jedd.internal.RelationContainer(new Attribute[] { fld.v(), dstc.v(), srcc.v(), dst.v(), src.v() },
                                                   new PhysicalDomain[] { FD.v(), C2.v(), C1.v(), V2.v(), V1.v() },
                                                   ("return ret; at /home/olhotak/soot-trunk/src/soot/jimple/padd" +
                                                    "le/queue/Rsrcc_src_fld_dstc_dstBDD.jedd:57,8-14"),
                                                   ret);
    }
