...
public final class Rvar_srcm_stmt_dtp_signature_kindBDD extends Rvar_srcm_stmt_dtp_signature_kind {
    ...
    public Rvar_srcm_stmt_dtp_signature_kindBDD(final jedd.internal.RelationContainer bdd, String name) {
        this(name);
        add(new jedd.internal.RelationContainer(new Attribute[] { srcm.v(), signature.v(), stmt.v(), dtp.v(), kind.v(), var.v() },
        ...
        return new Iterator() {
            ...
            public Object next() {
                if (it == null || !it.hasNext()) {
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { srcm.v(), signature.v(), stmt.v(), dtp.v(), kind.v(), var.v() },
                                                          new PhysicalDomain[] { MS.v(), SG.v(), ST.v(), T1.v(), KD.v(), V1.v() },
