...
public final class Qobj_method_typeBDD extends Qobj_method_type {
    ...
    public void add(AllocNode _obj, SootMethod _method, Type _type) {
        add(new jedd.internal.RelationContainer(new Attribute[] { obj.v(), method.v(), type.v() },
                                                ...
                                                ("add(jedd.internal.Jedd.v().literal(new java.lang.Object[...]" +
                                                 ...
                                                 " /tmp/soot-trunk-saved/src/soot/jimple/paddle/queue/Qobj_met" +
                                                 "hod_typeBDD.jedd:34,8-11"),
    ...
    public void add(final jedd.internal.RelationContainer in) {
        ...
        for (Iterator it = readers.iterator(); it.hasNext(); ) {
            ...
            reader.add(new jedd.internal.RelationContainer(new Attribute[] { method.v(), obj.v(), type.v() },
                                                           new PhysicalDomain[] { MS.v(), H1.v(), T1.v() },
                                                           ("reader.add(in) at /tmp/soot-trunk-saved/src/soot/jimple/padd" +
                                                            "le/queue/Qobj_method_typeBDD.jedd:40,12-18"),
                                                           in));
        }
    }
