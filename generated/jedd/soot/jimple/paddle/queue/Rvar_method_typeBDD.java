    ...
    private final jedd.internal.RelationContainer bdd =
      new jedd.internal.RelationContainer(new Attribute[] { var.v(), method.v(), type.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.var:soot.jimple.paddl" +
                                           ...
                                           "saved/src/soot/jimple/paddle/queue/Rvar_method_typeBDD.jedd:" +
                                           "31,12-40"));
    ...
    public Rvar_method_typeBDD(final jedd.internal.RelationContainer bdd, String name) {
        ...
        add(new jedd.internal.RelationContainer(new Attribute[] { var.v(), method.v(), type.v() },
                                                ...
                                                ("add(bdd) at /tmp/soot-trunk-saved/src/soot/jimple/paddle/que" +
                                                 "ue/Rvar_method_typeBDD.jedd:33,94-97"),
                                                bdd));
    }
                    ...
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { var.v(), method.v(), type.v() },
                                                          ...
                                                          ("bdd.iterator(new jedd.Attribute[...]) at /tmp/soot-trunk-sav" +
                                                           "ed/src/soot/jimple/paddle/queue/Rvar_method_typeBDD.jedd:45," +
                                                           "25-28"),
        ...
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { var.v(), method.v(), type.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.var:soot.jimple.paddle.bdddom" +
                                               ...
                                               "aved/src/soot/jimple/paddle/queue/Rvar_method_typeBDD.jedd:5" +
                                               "5,37-40"),
                                              bdd);
        bdd.eq(jedd.internal.Jedd.v().falseBDD());
