...
public final class Rvar_srcm_stmt_signature_kindBDD extends Rvar_srcm_stmt_signature_kind {
    ...
    public Rvar_srcm_stmt_signature_kindBDD(final jedd.internal.RelationContainer bdd, String name) {
        this(name);
        this.add(new jedd.internal.RelationContainer(new Attribute[] { stmt.v(), signature.v(), var.v(), srcm.v(), kind.v() },
                                                     new PhysicalDomain[] { ST.v(), SG.v(), V1.v(), MS.v(), KD.v() },
                                                     ("this.add(bdd) at /home/research/ccl/olhota/soot-trunk2/src/s" +
                                                      "oot/jimple/paddle/queue/Rvar_srcm_stmt_signature_kindBDD.jed" +
                                                      "d:33,128-131"),
                                                     bdd));
    }
        ...
        return new Iterator() {
            ...
            public Object next() {
                if (it == null || !it.hasNext()) {
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { stmt.v(), signature.v(), var.v(), srcm.v(), kind.v() },
                                                          new PhysicalDomain[] { ST.v(), SG.v(), V1.v(), MS.v(), KD.v() },
    ...
    public jedd.internal.RelationContainer get() {
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { var.v(), srcm.v(), stmt.v(), signature.v(), kind.v() },
                                              ...
                                              bdd);
        bdd.eq(jedd.internal.Jedd.v().falseBDD());
        return new jedd.internal.RelationContainer(new Attribute[] { stmt.v(), signature.v(), var.v(), srcm.v(), kind.v() },
                                                   new PhysicalDomain[] { ST.v(), SG.v(), V1.v(), MS.v(), KD.v() },
