...
public class Rctxt_var_obj_srcm_stmt_kind_tgtmDebug extends Rctxt_var_obj_srcm_stmt_kind_tgtm {
    protected Rctxt_var_obj_srcm_stmt_kind_tgtmBDD bdd;
    
    protected Rctxt_var_obj_srcm_stmt_kind_tgtmSet trad;
    
    public Rctxt_var_obj_srcm_stmt_kind_tgtmDebug(Rctxt_var_obj_srcm_stmt_kind_tgtmBDD bdd,
                                                  Rctxt_var_obj_srcm_stmt_kind_tgtmSet trad,
                                                  String name) {
        super(name);
        this.bdd = bdd;
        this.trad = trad;
