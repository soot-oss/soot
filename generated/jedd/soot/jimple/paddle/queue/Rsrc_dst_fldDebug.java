...
public class Rsrc_dst_fldDebug extends Rsrc_dst_fld {
    protected Rsrc_dst_fldBDD bdd;
    
    protected Rsrc_dst_fldSet trad;
    
    public Rsrc_dst_fldDebug(Rsrc_dst_fldBDD bdd, Rsrc_dst_fldSet trad, String name) {
        super(name);
        this.bdd = bdd;
        this.trad = trad;
    }
