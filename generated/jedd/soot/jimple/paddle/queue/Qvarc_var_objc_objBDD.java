...
public final class Qvarc_var_objc_objBDD extends Qvarc_var_objc_obj {
    ...
    public void add(Context _varc, VarNode _var, Context _objc, AllocNode _obj) {
        add(new jedd.internal.RelationContainer(new Attribute[] { varc.v(), var.v(), objc.v(), obj.v() },
                                                ...
                                                ("add(jedd.internal.Jedd.v().literal(new java.lang.Object[...]" +
                                                 ...
                                                 "/queue/Qvarc_var_objc_objBDD.jedd:34,8-11"),
    ...
    public void add(final jedd.internal.RelationContainer in) {
        ...
        for (Iterator it = readers.iterator(); it.hasNext(); ) {
            ...
            reader.add(new jedd.internal.RelationContainer(new Attribute[] { objc.v(), varc.v(), var.v(), obj.v() },
                                                           new PhysicalDomain[] { C2.v(), C1.v(), V1.v(), H1.v() },
                                                           ("reader.add(in) at /home/research/ccl/olhota/soot-trunk/src/s" +
                                                            "oot/jimple/paddle/queue/Qvarc_var_objc_objBDD.jedd:40,12-18"),
                                                           in));
        }
    }
