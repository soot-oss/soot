...
public final class Rvar_typeMerge extends Rvar_type {
    void add(final jedd.internal.RelationContainer tuple) { throw new RuntimeException(); }
    
    private Rvar_type in1;
    
    private Rvar_type in2;
    
    public Rvar_typeMerge(Rvar_type in1, Rvar_type in2) {
    ...
    public jedd.internal.RelationContainer get() {
        return new jedd.internal.RelationContainer(new Attribute[] { type.v(), var.v() },
                                                   ...
                                                   ("return jedd.internal.Jedd.v().union(jedd.internal.Jedd.v().r" +
                                                    ...
                                                    "t-jedd/src/soot/jimple/paddle/queue/Rvar_typeMerge.jedd:52,8" +
                                                    "-14"),
