...
public class Rctxt_var_obj_srcm_stmt_kind_tgtmSet extends Rctxt_var_obj_srcm_stmt_kind_tgtm {
    public Rctxt_var_obj_srcm_stmt_kind_tgtmSet(String name) { super(name); }
