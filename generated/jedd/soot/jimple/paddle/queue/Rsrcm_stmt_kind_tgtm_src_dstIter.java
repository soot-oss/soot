    ...
    public jedd.internal.RelationContainer get() {
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { srcm.v(), stmt.v(), kind.v(), tgtm.v(), src.v(), dst.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.srcm:soot.jimple.paddle.bdddo" +
                                               ...
                                               "edd.internal.Jedd.v().falseBDD(); at /tmp/soot-trunk-saved/s" +
                                               "rc/soot/jimple/paddle/queue/Rsrcm_stmt_kind_tgtm_src_dstIter" +
                                               ".jedd:46,61-64"),
        ...
        return new jedd.internal.RelationContainer(new Attribute[] { tgtm.v(), stmt.v(), dst.v(), srcm.v(), kind.v(), src.v() },
                                                   ...
                                                   ("return ret; at /tmp/soot-trunk-saved/src/soot/jimple/paddle/" +
                                                    "queue/Rsrcm_stmt_kind_tgtm_src_dstIter.jedd:50,8-14"),
                                                   ret);
    }
