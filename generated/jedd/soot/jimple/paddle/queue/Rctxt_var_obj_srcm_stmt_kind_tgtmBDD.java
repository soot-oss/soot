...
public final class Rctxt_var_obj_srcm_stmt_kind_tgtmBDD extends Rctxt_var_obj_srcm_stmt_kind_tgtm {
    private final jedd.internal.RelationContainer bdd =
      new jedd.internal.RelationContainer(new Attribute[] { ctxt.v(), var.v(), obj.v(), srcm.v(), stmt.v(), kind.v(), tgtm.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.ctxt:soot.jimple.padd" +
                                           ...
                                           "mains.MT> bdd at /home/research/ccl/olhota/soot-trunk2/src/s" +
                                           "oot/jimple/paddle/queue/Rctxt_var_obj_srcm_stmt_kind_tgtmBDD" +
                                           ".jedd:31,12-73"));
    ...
    public Rctxt_var_obj_srcm_stmt_kind_tgtmBDD(final jedd.internal.RelationContainer bdd, String name) {
        this(name);
        this.add(new jedd.internal.RelationContainer(new Attribute[] { stmt.v(), ctxt.v(), tgtm.v(), var.v(), srcm.v(), kind.v(), obj.v() },
                                                     new PhysicalDomain[] { ST.v(), C2.v(), MT.v(), V1.v(), MS.v(), KD.v(), H1.v() },
        ...
        return new Iterator() {
            ...
            public Object next() {
                if (it == null || !it.hasNext()) {
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { stmt.v(), ctxt.v(), tgtm.v(), var.v(), srcm.v(), kind.v(), obj.v() },
                                                          new PhysicalDomain[] { ST.v(), C2.v(), MT.v(), V1.v(), MS.v(), KD.v(), H1.v() },
                                                          ("bdd.iterator(new jedd.Attribute[...]) at /home/research/ccl/" +
                                                           "olhota/soot-trunk2/src/soot/jimple/paddle/queue/Rctxt_var_ob" +
                                                           "j_srcm_stmt_kind_tgtmBDD.jedd:45,25-28"),
        ...
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { ctxt.v(), var.v(), obj.v(), srcm.v(), stmt.v(), kind.v(), tgtm.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.ctxt:soot.jimple.paddle.bdddo" +
                                               ...
                                               "> ret = bdd; at /home/research/ccl/olhota/soot-trunk2/src/so" +
                                               "ot/jimple/paddle/queue/Rctxt_var_obj_srcm_stmt_kind_tgtmBDD." +
                                               "jedd:55,70-73"),
                                              bdd);
        bdd.eq(jedd.internal.Jedd.v().falseBDD());
        return new jedd.internal.RelationContainer(new Attribute[] { stmt.v(), ctxt.v(), tgtm.v(), var.v(), srcm.v(), kind.v(), obj.v() },
                                                   new PhysicalDomain[] { ST.v(), C2.v(), MT.v(), V1.v(), MS.v(), KD.v(), H1.v() },
