    ...
    private final jedd.internal.RelationContainer bdd =
      new jedd.internal.RelationContainer(new Attribute[] { objc.v(), obj.v(), varc.v(), var.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.objc:soot.jimple.padd" +
                                           ...
                                           "arch/ccl/olhota/soot-trunk2/src/soot/jimple/paddle/queue/Rob" +
                                           "jc_obj_varc_varBDD.jedd:31,12-46"));
    
    void add(final jedd.internal.RelationContainer tuple) { bdd.eqUnion(tuple); }
    
    public Robjc_obj_varc_varBDD(final jedd.internal.RelationContainer bdd, String name) {
        this(name);
        add(new jedd.internal.RelationContainer(new Attribute[] { var.v(), obj.v(), objc.v(), varc.v() },
                                                new PhysicalDomain[] { V1.v(), H1.v(), C2.v(), C1.v() },
                                                ("add(bdd) at /home/research/ccl/olhota/soot-trunk2/src/soot/j" +
                                                 "imple/paddle/queue/Robjc_obj_varc_varBDD.jedd:33,102-105"),
                                                bdd));
    }
                    ...
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { var.v(), obj.v(), objc.v(), varc.v() },
                                                          ...
                                                          ("bdd.iterator(new jedd.Attribute[...]) at /home/research/ccl/" +
                                                           "olhota/soot-trunk2/src/soot/jimple/paddle/queue/Robjc_obj_va" +
                                                           "rc_varBDD.jedd:45,25-28"),
    ...
    public jedd.internal.RelationContainer get() {
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { objc.v(), obj.v(), varc.v(), var.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.objc:soot.jimple.paddle.bdddo" +
                                               ...
                                               "rch/ccl/olhota/soot-trunk2/src/soot/jimple/paddle/queue/Robj" +
                                               "c_obj_varc_varBDD.jedd:55,43-46"),
                                              bdd);
        bdd.eq(jedd.internal.Jedd.v().falseBDD());
        return new jedd.internal.RelationContainer(new Attribute[] { var.v(), obj.v(), objc.v(), varc.v() },
                                                   ...
                                                   ("return ret; at /home/research/ccl/olhota/soot-trunk2/src/soo" +
                                                    "t/jimple/paddle/queue/Robjc_obj_varc_varBDD.jedd:57,8-14"),
                                                   ret);
    }
