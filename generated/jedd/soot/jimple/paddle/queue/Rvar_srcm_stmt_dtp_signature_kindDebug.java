...
public class Rvar_srcm_stmt_dtp_signature_kindDebug extends Rvar_srcm_stmt_dtp_signature_kind {
    protected Rvar_srcm_stmt_dtp_signature_kindBDD bdd;
    
    protected Rvar_srcm_stmt_dtp_signature_kindSet trad;
    
    public Rvar_srcm_stmt_dtp_signature_kindDebug(Rvar_srcm_stmt_dtp_signature_kindBDD bdd,
                                                  Rvar_srcm_stmt_dtp_signature_kindSet trad,
                                                  String name) {
        super(name);
        this.bdd = bdd;
        this.trad = trad;
