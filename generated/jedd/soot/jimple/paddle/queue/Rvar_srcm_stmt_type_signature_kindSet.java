...
public class Rvar_srcm_stmt_type_signature_kindSet extends Rvar_srcm_stmt_type_signature_kind {
    public Rvar_srcm_stmt_type_signature_kindSet(String name) { super(name); }
