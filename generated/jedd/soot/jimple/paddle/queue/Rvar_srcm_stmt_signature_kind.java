...
public abstract class Rvar_srcm_stmt_signature_kind implements Readers.Reader {
    public Rvar_srcm_stmt_signature_kind(String name) {
        super();
        this.name = name;
        Readers.v().add(this);
    }
    ...
    public static class Tuple {
        ...
        public Tuple(VarNode _var, SootMethod _srcm, Unit _stmt, NumberedString _signature, Kind _kind) {
            super();
            this._var = _var;
            this._srcm = _srcm;
            this._stmt = _stmt;
