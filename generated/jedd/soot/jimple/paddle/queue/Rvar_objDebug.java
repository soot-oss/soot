...
public class Rvar_objDebug extends Rvar_obj {
    protected Rvar_objBDD bdd;
    
    protected Rvar_objSet trad;
    
    public Rvar_objDebug(Rvar_objBDD bdd, Rvar_objSet trad, String name) {
        super(name);
        this.bdd = bdd;
        this.trad = trad;
    }
