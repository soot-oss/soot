...
public class Rsrc_fld_dstDebug extends Rsrc_fld_dst {
    protected Rsrc_fld_dstBDD bdd;
    
    protected Rsrc_fld_dstSet trad;
    
    public Rsrc_fld_dstDebug(Rsrc_fld_dstBDD bdd, Rsrc_fld_dstSet trad, String name) {
        super(name);
        this.bdd = bdd;
        this.trad = trad;
    }
