    ...
    private final jedd.internal.RelationContainer bdd =
      new jedd.internal.RelationContainer(new Attribute[] { src.v(), fld.v(), dst.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.src:soot.jimple.paddl" +
                                           ...
                                           "lhota/olhotak/soot-trunk/src/soot/jimple/paddle/queue/Rsrc_f" +
                                           "ld_dstBDD.jedd:31,12-36"));
    ...
    public Rsrc_fld_dstBDD(final jedd.internal.RelationContainer bdd, String name) {
        ...
        add(new jedd.internal.RelationContainer(new Attribute[] { dst.v(), src.v(), fld.v() },
                                                ...
                                                ("add(bdd) at /home/research/ccl/olhota/olhotak/soot-trunk/src" +
                                                 "/soot/jimple/paddle/queue/Rsrc_fld_dstBDD.jedd:33,86-89"),
                                                bdd));
    }
    ...
    public jedd.internal.RelationContainer get() {
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { src.v(), fld.v(), dst.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.src:soot.jimple.paddle.bdddom" +
                                               ...
                                               "hota/olhotak/soot-trunk/src/soot/jimple/paddle/queue/Rsrc_fl" +
                                               "d_dstBDD.jedd:55,33-36"),
                                              bdd);
        bdd.eq(jedd.internal.Jedd.v().falseBDD());
        return new jedd.internal.RelationContainer(new Attribute[] { dst.v(), src.v(), fld.v() },
                                                   ...
                                                   ("return ret; at /home/research/ccl/olhota/olhotak/soot-trunk/" +
                                                    "src/soot/jimple/paddle/queue/Rsrc_fld_dstBDD.jedd:57,8-14"),
                                                   ret);
    }
