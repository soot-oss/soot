    ...
    private final jedd.internal.RelationContainer bdd =
      new jedd.internal.RelationContainer(new Attribute[] { src.v(), fld.v(), dst.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.src:soot.jimple.paddl" +
                                           ...
                                           "oot.jimple.paddle.bdddomains.V2> bdd at /tmp/soot-trunk-save" +
                                           "d/src/soot/jimple/paddle/queue/Rsrc_fld_dstBDD.jedd:31,12-36"));
    ...
    public Rsrc_fld_dstBDD(final jedd.internal.RelationContainer bdd, String name) {
        ...
        add(new jedd.internal.RelationContainer(new Attribute[] { fld.v(), dst.v(), src.v() },
                                                ...
                                                ("add(bdd) at /tmp/soot-trunk-saved/src/soot/jimple/paddle/que" +
                                                 "ue/Rsrc_fld_dstBDD.jedd:33,86-89"),
                                                bdd));
    }
                    ...
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { fld.v(), dst.v(), src.v() },
                                                          ...
                                                          ("bdd.iterator(new jedd.Attribute[...]) at /tmp/soot-trunk-sav" +
                                                           "ed/src/soot/jimple/paddle/queue/Rsrc_fld_dstBDD.jedd:45,25-2" +
                                                           "8"),
        ...
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { src.v(), fld.v(), dst.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.src:soot.jimple.paddle.bdddom" +
                                               ...
                                               "le.paddle.bdddomains.V2> ret = bdd; at /tmp/soot-trunk-saved" +
                                               "/src/soot/jimple/paddle/queue/Rsrc_fld_dstBDD.jedd:55,33-36"),
                                              bdd);
        bdd.eq(jedd.internal.Jedd.v().falseBDD());
