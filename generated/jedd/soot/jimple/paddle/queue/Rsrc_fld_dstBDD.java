...
public final class Rsrc_fld_dstBDD extends Rsrc_fld_dst {
    private final jedd.internal.RelationContainer bdd =
      new jedd.internal.RelationContainer(new Attribute[] { src.v(), fld.v(), dst.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.src:soot.jimple.paddl" +
                                           ...
                                           "oot.jimple.paddle.bdddomains.V2> bdd at /tmp/olhotak/soot-tr" +
                                           "unk/src/soot/jimple/paddle/queue/Rsrc_fld_dstBDD.jedd:31,12-" +
                                           "36"));
    ...
    public Rsrc_fld_dstBDD(final jedd.internal.RelationContainer bdd, String name) {
        this(name);
        add(new jedd.internal.RelationContainer(new Attribute[] { dst.v(), fld.v(), src.v() },
                                                new PhysicalDomain[] { V2.v(), FD.v(), V1.v() },
                                                ("add(bdd) at /tmp/olhotak/soot-trunk/src/soot/jimple/paddle/q" +
                                                 "ueue/Rsrc_fld_dstBDD.jedd:33,86-89"),
                                                bdd));
    }
                    ...
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { dst.v(), fld.v(), src.v() },
                                                          ...
                                                          ("bdd.iterator(new jedd.Attribute[...]) at /tmp/olhotak/soot-t" +
                                                           "runk/src/soot/jimple/paddle/queue/Rsrc_fld_dstBDD.jedd:45,25" +
                                                           "-28"),
        ...
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { src.v(), fld.v(), dst.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.src:soot.jimple.paddle.bdddom" +
                                               ...
                                               "le.paddle.bdddomains.V2> ret = bdd; at /tmp/olhotak/soot-tru" +
                                               "nk/src/soot/jimple/paddle/queue/Rsrc_fld_dstBDD.jedd:55,33-3" +
                                               "6"),
                                              bdd);
        bdd.eq(jedd.internal.Jedd.v().falseBDD());
