...
public class Rsrcc_src_dstc_dstDebug extends Rsrcc_src_dstc_dst {
    protected Rsrcc_src_dstc_dstBDD bdd;
    
    protected Rsrcc_src_dstc_dstSet trad;
    
    public Rsrcc_src_dstc_dstDebug(Rsrcc_src_dstc_dstBDD bdd, Rsrcc_src_dstc_dstSet trad, String name) {
        super(name);
        this.bdd = bdd;
        this.trad = trad;
    }
