...
public class Rsrcm_stmt_kind_tgtm_src_dstNumTrace extends Rsrcm_stmt_kind_tgtm_src_dst {
    public Rsrcm_stmt_kind_tgtm_src_dstNumTrace(String name) { super(name); }
