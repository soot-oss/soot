...
public final class Robj_typeMerge extends Robj_type {
    void add(final jedd.internal.RelationContainer tuple) { throw new RuntimeException(); }
    
    private Robj_type in1;
    
    private Robj_type in2;
    
    public Robj_typeMerge(Robj_type in1, Robj_type in2) {
    ...
    public jedd.internal.RelationContainer get() {
        return new jedd.internal.RelationContainer(new Attribute[] { type.v(), obj.v() },
                                                   ...
                                                   ("return jedd.internal.Jedd.v().union(jedd.internal.Jedd.v().r" +
                                                    ...
                                                    "t-trunk2/src/soot/jimple/paddle/queue/Robj_typeMerge.jedd:52" +
                                                    ",8-14"),
