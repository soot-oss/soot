...
public class Rvar_srcm_stmt_tgtmDebug extends Rvar_srcm_stmt_tgtm {
    protected Rvar_srcm_stmt_tgtmBDD bdd;
    
    protected Rvar_srcm_stmt_tgtmSet trad;
    
    public Rvar_srcm_stmt_tgtmDebug(Rvar_srcm_stmt_tgtmBDD bdd, Rvar_srcm_stmt_tgtmSet trad, String name) {
        super(name);
        this.bdd = bdd;
        this.trad = trad;
    }
