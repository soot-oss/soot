...
public class Rvar_srcm_stmt_dtp_signature_kindNumTrace extends Rvar_srcm_stmt_dtp_signature_kind {
    public Rvar_srcm_stmt_dtp_signature_kindNumTrace(String name) { super(name); }
