...
public final class Rsrcm_stmt_kind_tgtm_src_dstBDD extends Rsrcm_stmt_kind_tgtm_src_dst {
    ...
    public Rsrcm_stmt_kind_tgtm_src_dstBDD(final jedd.internal.RelationContainer bdd, String name) {
        this(name);
        this.add(new jedd.internal.RelationContainer(new Attribute[] { src.v(), tgtm.v(), kind.v(), dst.v(), srcm.v(), stmt.v() },
        ...
        return new Iterator() {
            ...
            public Object next() {
                if (it == null || !it.hasNext()) {
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { src.v(), tgtm.v(), kind.v(), dst.v(), srcm.v(), stmt.v() },
                                                          new PhysicalDomain[] { V1.v(), T2.v(), FD.v(), V2.v(), T1.v(), ST.v() },
