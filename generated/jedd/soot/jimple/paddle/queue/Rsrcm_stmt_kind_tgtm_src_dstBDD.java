...
public final class Rsrcm_stmt_kind_tgtm_src_dstBDD extends Rsrcm_stmt_kind_tgtm_src_dst {
    ...
    public Rsrcm_stmt_kind_tgtm_src_dstBDD(final jedd.internal.RelationContainer bdd, String name) {
        this(name);
        add(new jedd.internal.RelationContainer(new Attribute[] { srcm.v(), stmt.v(), tgtm.v(), src.v(), kind.v(), dst.v() },
                                                new PhysicalDomain[] { MS.v(), ST.v(), MT.v(), V1.v(), KD.v(), V2.v() },
                                                ("add(bdd) at /home/research/ccl/olhota/soot-trunk2/src/soot/j" +
                                                 "imple/paddle/queue/Rsrcm_stmt_kind_tgtm_src_dstBDD.jedd:33,1" +
                                                 "30-133"),
                                                bdd));
    }
