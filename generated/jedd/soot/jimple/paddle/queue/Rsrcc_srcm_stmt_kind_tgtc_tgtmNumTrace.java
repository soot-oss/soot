...
public class Rsrcc_srcm_stmt_kind_tgtc_tgtmNumTrace extends Rsrcc_srcm_stmt_kind_tgtc_tgtm {
    public Rsrcc_srcm_stmt_kind_tgtc_tgtmNumTrace(String name) { super(name); }
