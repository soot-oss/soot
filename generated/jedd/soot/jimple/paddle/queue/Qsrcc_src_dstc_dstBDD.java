...
public final class Qsrcc_src_dstc_dstBDD extends Qsrcc_src_dstc_dst {
    ...
    public void add(Context _srcc, VarNode _src, Context _dstc, VarNode _dst) {
        add(new jedd.internal.RelationContainer(new Attribute[] { srcc.v(), src.v(), dstc.v(), dst.v() },
                                                ...
                                                ("add(jedd.internal.Jedd.v().literal(new java.lang.Object[...]" +
                                                 ...
                                                 "/queue/Qsrcc_src_dstc_dstBDD.jedd:34,8-11"),
    ...
    public void add(final jedd.internal.RelationContainer in) {
        ...
        for (Iterator it = readers.iterator(); it.hasNext(); ) {
            ...
            reader.add(new jedd.internal.RelationContainer(new Attribute[] { dstc.v(), src.v(), dst.v(), srcc.v() },
                                                           new PhysicalDomain[] { C2.v(), V1.v(), V2.v(), C1.v() },
                                                           ("reader.add(in) at /home/research/ccl/olhota/soot-trunk/src/s" +
                                                            "oot/jimple/paddle/queue/Qsrcc_src_dstc_dstBDD.jedd:40,12-18"),
                                                           in));
        }
    }
