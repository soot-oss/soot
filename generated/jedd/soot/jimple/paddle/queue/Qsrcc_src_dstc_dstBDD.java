...
public final class Qsrcc_src_dstc_dstBDD extends Qsrcc_src_dstc_dst {
    ...
    public void add(Context _srcc, VarNode _src, Context _dstc, VarNode _dst) {
        this.add(new jedd.internal.RelationContainer(new Attribute[] { srcc.v(), src.v(), dstc.v(), dst.v() },
                                                     ...
                                                     ("this.add(jedd.internal.Jedd.v().literal(new java.lang.Object" +
                                                      ...
                                                      "paddle/queue/Qsrcc_src_dstc_dstBDD.jedd:34,8-11"),
    ...
    public void add(final jedd.internal.RelationContainer in) {
        for (Iterator it = readers.iterator(); it.hasNext(); ) {
            ...
            reader.add(new jedd.internal.RelationContainer(new Attribute[] { dstc.v(), src.v(), srcc.v(), dst.v() },
                                                           new PhysicalDomain[] { C2.v(), V1.v(), C1.v(), V2.v() },
                                                           ("reader.add(in) at /home/research/ccl/olhota/soot-trunk2/src/" +
                                                            "soot/jimple/paddle/queue/Qsrcc_src_dstc_dstBDD.jedd:39,12-18"),
                                                           in));
        }
    }
