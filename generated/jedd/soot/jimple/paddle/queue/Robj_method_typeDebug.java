...
public class Robj_method_typeDebug extends Robj_method_type {
    protected Robj_method_typeBDD bdd;
    
    protected Robj_method_typeSet trad;
    
    public Robj_method_typeDebug(Robj_method_typeBDD bdd, Robj_method_typeSet trad, String name) {
        super(name);
        this.bdd = bdd;
        this.trad = trad;
    }
