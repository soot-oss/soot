...
public final class Rvar_objMerge extends Rvar_obj {
    void add(final jedd.internal.RelationContainer tuple) { throw new RuntimeException(); }
    
    private Rvar_obj in1;
    
    private Rvar_obj in2;
    
    public Rvar_objMerge(Rvar_obj in1, Rvar_obj in2) {
    ...
    public jedd.internal.RelationContainer get() {
        return new jedd.internal.RelationContainer(new Attribute[] { var.v(), obj.v() },
                                                   ...
                                                   ("return jedd.internal.Jedd.v().union(jedd.internal.Jedd.v().r" +
                                                    ...
                                                    "otak/soot-trunk/src/soot/jimple/paddle/queue/Rvar_objMerge.j" +
                                                    "edd:52,8-14"),
