...
public class Rsrcm_stmt_kind_tgtm_src_dstDebug extends Rsrcm_stmt_kind_tgtm_src_dst {
    protected Rsrcm_stmt_kind_tgtm_src_dstBDD bdd;
    
    protected Rsrcm_stmt_kind_tgtm_src_dstSet trad;
    
    public Rsrcm_stmt_kind_tgtm_src_dstDebug(Rsrcm_stmt_kind_tgtm_src_dstBDD bdd,
                                             Rsrcm_stmt_kind_tgtm_src_dstSet trad,
                                             String name) {
        super(name);
        this.bdd = bdd;
        this.trad = trad;
