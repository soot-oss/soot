...
public final class Qsrcm_stmt_kind_tgtm_src_dstBDD extends Qsrcm_stmt_kind_tgtm_src_dst {
    ...
    public void add(final jedd.internal.RelationContainer in) {
        ...
        for (Iterator it = readers.iterator(); it.hasNext(); ) {
            ...
            reader.add(new jedd.internal.RelationContainer(new Attribute[] { tgtm.v(), src.v(), dst.v(), srcm.v(), kind.v(), stmt.v() },
                                                           new PhysicalDomain[] { MT.v(), V1.v(), V2.v(), MS.v(), KD.v(), ST.v() },
                                                           ("reader.add(in) at /home/research/ccl/olhota/soot-jedd/src/so" +
                                                            "ot/jimple/paddle/queue/Qsrcm_stmt_kind_tgtm_src_dstBDD.jedd:" +
                                                            "40,12-18"),
                                                           in));
        }
    }
