    ...
    public jedd.internal.RelationContainer get() {
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { var.v(), srcm.v(), stmt.v(), tgtm.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.var:soot.jimple.paddle.bdddom" +
                                               ...
                                               ".v().falseBDD(); at /home/research/ccl/olhota/olhotak/soot-t" +
                                               "runk/src/soot/jimple/paddle/queue/Rvar_srcm_stmt_tgtmIter.je" +
                                               "dd:46,44-47"),
        ...
        return new jedd.internal.RelationContainer(new Attribute[] { srcm.v(), var.v(), stmt.v(), tgtm.v() },
                                                   ...
                                                   ("return ret; at /home/research/ccl/olhota/olhotak/soot-trunk/" +
                                                    "src/soot/jimple/paddle/queue/Rvar_srcm_stmt_tgtmIter.jedd:50" +
                                                    ",8-14"),
                                                   ret);
    }
