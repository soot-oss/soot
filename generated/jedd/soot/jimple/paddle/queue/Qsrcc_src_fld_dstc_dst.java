...
public abstract class Qsrcc_src_fld_dstc_dst implements DepItem {
    ...
    public Rsrcc_src_fld_dstc_dst revreader(String rname) { return reader(rname); }
    
    public void add(Rsrcc_src_fld_dstc_dst.Tuple in) { add(in.srcc(), in.src(), in.fld(), in.dstc(), in.dst()); }
