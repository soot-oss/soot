...
public class Rctxt_local_obj_srcm_stmt_kind_tgtmNumTrace extends Rctxt_local_obj_srcm_stmt_kind_tgtm {
    public Rctxt_local_obj_srcm_stmt_kind_tgtmNumTrace(String name) { super(name); }
