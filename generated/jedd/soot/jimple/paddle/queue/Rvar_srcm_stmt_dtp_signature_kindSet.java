...
public class Rvar_srcm_stmt_dtp_signature_kindSet extends Rvar_srcm_stmt_dtp_signature_kind {
    public Rvar_srcm_stmt_dtp_signature_kindSet(String name) { super(name); }
