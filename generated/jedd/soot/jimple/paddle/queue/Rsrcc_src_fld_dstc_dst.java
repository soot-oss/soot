...
public abstract class Rsrcc_src_fld_dstc_dst implements Readers.Reader {
    public Rsrcc_src_fld_dstc_dst(String name) {
        super();
        this.name = name;
        Readers.v().add(this);
    }
    ...
    public static class Tuple {
        ...
        public Tuple(Context _srcc, VarNode _src, PaddleField _fld, Context _dstc, VarNode _dst) {
            super();
            this._srcc = _srcc;
            this._src = _src;
            this._fld = _fld;
