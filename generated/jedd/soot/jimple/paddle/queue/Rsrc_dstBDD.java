    ...
    private final jedd.internal.RelationContainer bdd =
      new jedd.internal.RelationContainer(new Attribute[] { src.v(), dst.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.src:soot.jimple.paddl" +
                                           ...
                                           "le.paddle.bdddomains.V2> bdd at /home/olhotak/soot-trunk/src" +
    ...
    public Rsrc_dstBDD(final jedd.internal.RelationContainer bdd) {
        ...
        this.add(new jedd.internal.RelationContainer(new Attribute[] { src.v(), dst.v() },
                                                     ...
                                                     ("this.add(bdd) at /home/olhotak/soot-trunk/src/soot/jimple/pa" +
                                                      "ddle/queue/Rsrc_dstBDD.jedd:33,57-60"),
                                                     bdd));
    }
                    ...
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { src.v(), dst.v() },
                                                          ...
                                                          ("bdd.iterator(new jedd.Attribute[...]) at /home/olhotak/soot-" +
                                                           "trunk/src/soot/jimple/paddle/queue/Rsrc_dstBDD.jedd:45,25-28"),
    ...
    public jedd.internal.RelationContainer get() {
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { src.v(), dst.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.src:soot.jimple.paddle.bdddom" +
                                               ...
                                               "e.bdddomains.V2> ret = bdd; at /home/olhotak/soot-trunk/src/" +
        ...
        return new jedd.internal.RelationContainer(new Attribute[] { src.v(), dst.v() },
                                                   ...
                                                   ("return ret; at /home/olhotak/soot-trunk/src/soot/jimple/padd" +
                                                    "le/queue/Rsrc_dstBDD.jedd:57,8-14"),
                                                   ret);
    }
