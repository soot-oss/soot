    ...
    private final jedd.internal.RelationContainer bdd =
      new jedd.internal.RelationContainer(new Attribute[] { src.v(), dst.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.src:soot.jimple.paddl" +
                                           ...
                                           "le.paddle.bdddomains.V2> bdd at /tmp/soot-trunk/src/soot/jim" +
                                           "ple/paddle/queue/Rsrc_dstBDD.jedd:31,12-28"));
                    ...
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { dst.v(), src.v() },
                                                          ...
                                                          ("bdd.iterator(new jedd.Attribute[...]) at /tmp/soot-trunk/src" +
                                                           "/soot/jimple/paddle/queue/Rsrc_dstBDD.jedd:45,25-28"),
        ...
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { src.v(), dst.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.src:soot.jimple.paddle.bdddom" +
                                               ...
                                               "e.bdddomains.V2> ret = bdd; at /tmp/soot-trunk/src/soot/jimp" +
                                               "le/paddle/queue/Rsrc_dstBDD.jedd:55,25-28"),
                                              bdd);
        bdd.eq(jedd.internal.Jedd.v().falseBDD());
