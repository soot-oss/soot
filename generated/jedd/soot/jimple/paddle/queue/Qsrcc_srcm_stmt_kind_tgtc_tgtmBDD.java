...
public final class Qsrcc_srcm_stmt_kind_tgtc_tgtmBDD extends Qsrcc_srcm_stmt_kind_tgtc_tgtm {
    ...
    public void add(final jedd.internal.RelationContainer in) {
        ...
        for (Iterator it = readers.iterator(); it.hasNext(); ) {
            ...
            reader.add(new jedd.internal.RelationContainer(new Attribute[] { tgtc.v(), tgtm.v(), srcc.v(), srcm.v(), kind.v(), stmt.v() },
                                                           new PhysicalDomain[] { C2.v(), MT.v(), C1.v(), MS.v(), KD.v(), ST.v() },
                                                           ("reader.add(in) at /home/research/ccl/olhota/soot-jedd/src/so" +
                                                            "ot/jimple/paddle/queue/Qsrcc_srcm_stmt_kind_tgtc_tgtmBDD.jed" +
                                                            "d:40,12-18"),
                                                           in));
        }
    }
