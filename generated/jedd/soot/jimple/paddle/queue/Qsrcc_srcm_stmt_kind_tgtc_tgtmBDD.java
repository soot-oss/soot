...
public final class Qsrcc_srcm_stmt_kind_tgtc_tgtmBDD extends Qsrcc_srcm_stmt_kind_tgtc_tgtm {
    ...
    public void add(final jedd.internal.RelationContainer in) {
        for (Iterator it = readers.iterator(); it.hasNext(); ) {
            ...
            reader.add(new jedd.internal.RelationContainer(new Attribute[] { stmt.v(), srcm.v(), tgtc.v(), kind.v(), tgtm.v(), srcc.v() },
                                                           new PhysicalDomain[] { ST.v(), T1.v(), V2.v(), FD.v(), T2.v(), V1.v() },
                                                           ("reader.add(in) at /home/olhotak/soot-trunk/src/soot/jimple/p" +
                                                            "addle/queue/Qsrcc_srcm_stmt_kind_tgtc_tgtmBDD.jedd:38,12-18"),
                                                           in));
        }
    }
