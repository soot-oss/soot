...
public final class Qobjc_obj_varc_varBDD extends Qobjc_obj_varc_var {
    ...
    public void add(Context _objc, AllocNode _obj, Context _varc, VarNode _var) {
        add(new jedd.internal.RelationContainer(new Attribute[] { objc.v(), obj.v(), varc.v(), var.v() },
                                                ...
                                                ("add(jedd.internal.Jedd.v().literal(new java.lang.Object[...]" +
                                                 ...
                                                 " /tmp/soot-trunk-saved/src/soot/jimple/paddle/queue/Qobjc_ob" +
                                                 "j_varc_varBDD.jedd:34,8-11"),
    ...
    public void add(final jedd.internal.RelationContainer in) {
        ...
        for (Iterator it = readers.iterator(); it.hasNext(); ) {
            ...
            reader.add(new jedd.internal.RelationContainer(new Attribute[] { var.v(), varc.v(), obj.v(), objc.v() },
                                                           new PhysicalDomain[] { V1.v(), C1.v(), H1.v(), C2.v() },
                                                           ("reader.add(in) at /tmp/soot-trunk-saved/src/soot/jimple/padd" +
                                                            "le/queue/Qobjc_obj_varc_varBDD.jedd:40,12-18"),
                                                           in));
        }
    }
