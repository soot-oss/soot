    ...
    private final jedd.internal.RelationContainer bdd =
      new jedd.internal.RelationContainer(new Attribute[] { varc.v(), var.v(), objc.v(), obj.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.varc:soot.jimple.padd" +
                                           ...
                                           "arch/ccl/olhota/soot-jedd/src/soot/jimple/paddle/queue/Rvarc" +
                                           "_var_objc_objBDD.jedd:31,12-46"));
    ...
    public Rvarc_var_objc_objBDD(final jedd.internal.RelationContainer bdd, String name) {
        ...
        add(new jedd.internal.RelationContainer(new Attribute[] { objc.v(), varc.v(), obj.v(), var.v() },
                                                ...
                                                ("add(bdd) at /home/research/ccl/olhota/soot-jedd/src/soot/jim" +
                                                 "ple/paddle/queue/Rvarc_var_objc_objBDD.jedd:33,102-105"),
                                                bdd));
    }
                    ...
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { objc.v(), varc.v(), obj.v(), var.v() },
                                                          ...
                                                          ("bdd.iterator(new jedd.Attribute[...]) at /home/research/ccl/" +
                                                           "olhota/soot-jedd/src/soot/jimple/paddle/queue/Rvarc_var_objc" +
                                                           "_objBDD.jedd:45,25-28"),
        ...
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { varc.v(), var.v(), objc.v(), obj.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.varc:soot.jimple.paddle.bdddo" +
                                               ...
                                               "rch/ccl/olhota/soot-jedd/src/soot/jimple/paddle/queue/Rvarc_" +
                                               "var_objc_objBDD.jedd:55,43-46"),
                                              bdd);
        bdd.eq(jedd.internal.Jedd.v().falseBDD());
