...
public final class Robj_method_typeBDD extends Robj_method_type {
    private final jedd.internal.RelationContainer bdd =
      new jedd.internal.RelationContainer(new Attribute[] { obj.v(), method.v(), type.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.obj:soot.jimple.paddl" +
                                           ...
                                           "pe:soot.jimple.paddle.bdddomains.T1> bdd at /home/olhotak/so" +
                                           "ot-trunk/src/soot/jimple/paddle/queue/Robj_method_typeBDD.je" +
                                           "dd:31,12-40"));
    ...
    public Robj_method_typeBDD(final jedd.internal.RelationContainer bdd, String name) {
        this(name);
        add(new jedd.internal.RelationContainer(new Attribute[] { type.v(), method.v(), obj.v() },
                                                new PhysicalDomain[] { T1.v(), MS.v(), H1.v() },
                                                ("add(bdd) at /home/olhotak/soot-trunk/src/soot/jimple/paddle/" +
                                                 "queue/Robj_method_typeBDD.jedd:33,94-97"),
                                                bdd));
    }
                    ...
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { type.v(), method.v(), obj.v() },
                                                          ...
                                                          ("bdd.iterator(new jedd.Attribute[...]) at /home/olhotak/soot-" +
                                                           "trunk/src/soot/jimple/paddle/queue/Robj_method_typeBDD.jedd:" +
                                                           "45,25-28"),
    ...
    public jedd.internal.RelationContainer get() {
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { obj.v(), method.v(), type.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.obj:soot.jimple.paddle.bdddom" +
                                               ...
                                               "jimple.paddle.bdddomains.T1> ret = bdd; at /home/olhotak/soo" +
                                               "t-trunk/src/soot/jimple/paddle/queue/Robj_method_typeBDD.jed" +
                                               "d:55,37-40"),
                                              bdd);
        bdd.eq(jedd.internal.Jedd.v().falseBDD());
        return new jedd.internal.RelationContainer(new Attribute[] { type.v(), method.v(), obj.v() },
                                                   ...
                                                   ("return ret; at /home/olhotak/soot-trunk/src/soot/jimple/padd" +
                                                    "le/queue/Robj_method_typeBDD.jedd:57,8-14"),
                                                   ret);
    }
