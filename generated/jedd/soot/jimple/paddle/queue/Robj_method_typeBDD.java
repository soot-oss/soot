...
public final class Robj_method_typeBDD extends Robj_method_type {
    private final jedd.internal.RelationContainer bdd =
      new jedd.internal.RelationContainer(new Attribute[] { obj.v(), method.v(), type.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.obj:soot.jimple.paddl" +
                                           ...
                                           "pe:soot.jimple.paddle.bdddomains.T1> bdd at /tmp/soot-trunk-" +
                                           "saved/src/soot/jimple/paddle/queue/Robj_method_typeBDD.jedd:" +
                                           "31,12-40"));
    ...
    public Robj_method_typeBDD(final jedd.internal.RelationContainer bdd, String name) {
        this(name);
        add(new jedd.internal.RelationContainer(new Attribute[] { method.v(), obj.v(), type.v() },
                                                new PhysicalDomain[] { MS.v(), H1.v(), T1.v() },
                                                ("add(bdd) at /tmp/soot-trunk-saved/src/soot/jimple/paddle/que" +
                                                 "ue/Robj_method_typeBDD.jedd:33,94-97"),
                                                bdd));
    }
                    ...
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { method.v(), obj.v(), type.v() },
                                                          ...
                                                          ("bdd.iterator(new jedd.Attribute[...]) at /tmp/soot-trunk-sav" +
                                                           "ed/src/soot/jimple/paddle/queue/Robj_method_typeBDD.jedd:45," +
                                                           "25-28"),
    ...
    public jedd.internal.RelationContainer get() {
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { obj.v(), method.v(), type.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.obj:soot.jimple.paddle.bdddom" +
                                               ...
                                               "jimple.paddle.bdddomains.T1> ret = bdd; at /tmp/soot-trunk-s" +
                                               "aved/src/soot/jimple/paddle/queue/Robj_method_typeBDD.jedd:5" +
                                               "5,37-40"),
                                              bdd);
        bdd.eq(jedd.internal.Jedd.v().falseBDD());
        return new jedd.internal.RelationContainer(new Attribute[] { method.v(), obj.v(), type.v() },
                                                   ...
                                                   ("return ret; at /tmp/soot-trunk-saved/src/soot/jimple/paddle/" +
                                                    "queue/Robj_method_typeBDD.jedd:57,8-14"),
                                                   ret);
    }
