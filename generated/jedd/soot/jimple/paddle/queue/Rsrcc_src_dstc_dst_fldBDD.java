    ...
    private final jedd.internal.RelationContainer bdd =
      new jedd.internal.RelationContainer(new Attribute[] { srcc.v(), src.v(), dstc.v(), dst.v(), fld.v() },
                                          ...
                                          ("private <soot.jimple.paddle.bdddomains.srcc:soot.jimple.padd" +
                                           ...
                                           "addle/queue/Rsrcc_src_dstc_dst_fldBDD.jedd:31,12-54"));
    ...
    public Rsrcc_src_dstc_dst_fldBDD(final jedd.internal.RelationContainer bdd, String name) {
        ...
        add(new jedd.internal.RelationContainer(new Attribute[] { dstc.v(), dst.v(), src.v(), srcc.v(), fld.v() },
                                                ...
                                                ("add(bdd) at /home/research/ccl/olhota/olhotak/soot-trunk/src" +
                                                 "/soot/jimple/paddle/queue/Rsrcc_src_dstc_dst_fldBDD.jedd:33," +
                                                 "114-117"),
                                                bdd));
    }
                    ...
                    it =
                      new jedd.internal.RelationContainer(new Attribute[] { dstc.v(), dst.v(), src.v(), srcc.v(), fld.v() },
                                                          ...
                                                          ("bdd.iterator(new jedd.Attribute[...]) at /home/research/ccl/" +
                                                           ...
                                                           "_src_dstc_dst_fldBDD.jedd:45,25-28"),
    ...
    public jedd.internal.RelationContainer get() {
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new Attribute[] { srcc.v(), src.v(), dstc.v(), dst.v(), fld.v() },
                                              ...
                                              ("<soot.jimple.paddle.bdddomains.srcc:soot.jimple.paddle.bdddo" +
                                               ...
                                               "ddle/queue/Rsrcc_src_dstc_dst_fldBDD.jedd:55,51-54"),
                                              bdd);
        bdd.eq(jedd.internal.Jedd.v().falseBDD());
        return new jedd.internal.RelationContainer(new Attribute[] { dstc.v(), dst.v(), src.v(), srcc.v(), fld.v() },
                                                   ...
                                                   ("return ret; at /home/research/ccl/olhota/olhotak/soot-trunk/" +
                                                    "src/soot/jimple/paddle/queue/Rsrcc_src_dstc_dst_fldBDD.jedd:" +
                                                    "57,8-14"),
                                                   ret);
    }
