...
public class Rctxt_var_obj_srcm_stmt_kind_tgtmNumTrace extends Rctxt_var_obj_srcm_stmt_kind_tgtm {
    public Rctxt_var_obj_srcm_stmt_kind_tgtmNumTrace(String name) { super(name); }
