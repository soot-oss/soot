...
public class Rlocal_srcm_stmt_signature_kindNumTrace extends Rlocal_srcm_stmt_signature_kind {
    public Rlocal_srcm_stmt_signature_kindNumTrace(String name) { super(name); }
