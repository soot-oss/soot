...
public class Rlocal_srcm_stmt_signature_kindSet extends Rlocal_srcm_stmt_signature_kind {
    public Rlocal_srcm_stmt_signature_kindSet(String name) { super(name); }
