...
public class SubExpr extends AdditiveExpr implements Cloneable {
    ...
    public void flushCollectionCache() {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public SubExpr clone() throws CloneNotSupportedException {
        SubExpr node = (SubExpr)super.clone();
        node.in$Circle(false);
        node.is$Final(false);
        return node;
    }
     @SuppressWarnings({"unchecked", "cast"})  public SubExpr copy() {
      try {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public SubExpr fullCopy() {
        SubExpr res = (SubExpr)copy();
