...
public class RShiftExpr extends ShiftExpr implements Cloneable {
    ...
    public void flushCollectionCache() {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public RShiftExpr clone() throws CloneNotSupportedException {
        RShiftExpr node = (RShiftExpr)super.clone();
        node.in$Circle(false);
        node.is$Final(false);
        return node;
    }
     @SuppressWarnings({"unchecked", "cast"})  public RShiftExpr copy() {
      try {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public RShiftExpr fullCopy() {
  ...
  public soot.Value eval(Body b) { return emitShiftExpr(b); }
    ...
    // Declared in Expressions.jrag at line 823
