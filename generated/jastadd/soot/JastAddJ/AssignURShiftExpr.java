...
public class AssignURShiftExpr extends AssignShiftExpr implements Cloneable {
    ...
    public void flushCollectionCache() {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public AssignURShiftExpr clone() throws CloneNotSupportedException {
        AssignURShiftExpr node = (AssignURShiftExpr)super.clone();
        node.in$Circle(false);
        node.is$Final(false);
        return node;
    }
     @SuppressWarnings({"unchecked", "cast"})  public AssignURShiftExpr copy() {
      try {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public AssignURShiftExpr fullCopy() {
        AssignURShiftExpr res = (AssignURShiftExpr)copy();
    ...
    // Declared in Expressions.jrag at line 149

  public soot.Value eval(Body b) { return emitShiftExpr(b); }

    // Declared in Expressions.jrag at line 177
  ...
  protected int numChildren() {
    ...
    // Declared in PrettyPrint.jadd at line 255
