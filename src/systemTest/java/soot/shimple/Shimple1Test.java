...
public class Shimple1Test extends AbstractTestingFramework {
	...
	public void testComplexPhi_1C() throws Exception {
		...
		SootMethod m = prepareTarget(methodSigFromComponents(TEST_CLASS, "java.io.InputStream", TEST_METHOD),
				TEST_CLASS);
	...
	/**
	 * TODO: on Java9 and Java11, only the java.* classes are being loaded. All of
	 * the others are not located in the "java.base" module but are in different
	 * standard modules. I'm not sure how to get Soot to load other modules.
	 * 
	 * @throws Exception
	 */
	@Test
	public void testStdLib() throws Exception {
		...
		// Run initial pass to ensure they are valid when processed without using
		// Shimple form.
		{
			int pass1 = testStdLibRun(rtJar, cls, false, false);
			int pass2 = testStdLibRun(rtJar, clsASM, false, true);
			Assert.assertEquals("ORIGINAL classes (total " + NUM_CLASSES + ") with errors!", 0,
					NUM_CLASSES - pass1 - pass2);
		}
		...
		// Reset Soot and process the classes but use Shimple this time to trigger bug.
		{
			...
			Assert.assertEquals("MODIFIED classes (total " + NUM_CLASSES + ") with errors!", 0,
					NUM_CLASSES - pass1 - pass2);
		}
	}
