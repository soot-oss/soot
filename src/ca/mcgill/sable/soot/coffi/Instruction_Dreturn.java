 ...
 */
public class Instruction_Dreturn extends Instruction_noargs {
   public Instruction_Dreturn() { super((byte)ByteCode.DRETURN); name = "dreturn"; branches = true; returns = true; }
}
