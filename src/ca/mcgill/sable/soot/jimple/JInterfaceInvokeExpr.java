...
class JInterfaceInvokeExpr extends AbstractInterfaceInvokeExpr implements InterfaceInvokeExpr
{
    JInterfaceInvokeExpr(Value base, SootMethod method, List args)
    {
