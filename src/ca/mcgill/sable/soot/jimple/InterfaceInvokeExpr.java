...
public class InterfaceInvokeExpr extends NonStaticInvokeExpr implements ToBriefStringOwner
{
    ...
    public String toBriefString()
    {
        ...
        buffer.append("interfaceinvoke " + ((ToBriefStringOwner) baseBox.getValue()).toBriefString() +
            "." + method.getName() + "(");
