...
import java.util.*;
class Helper{
   static String getFullMethodName( SootMethod method ){
   ...
   */
   ...
   static SootMethod getMethod( SootClass bClass , String methodName , List paramAsString ) throws ca.mcgill.sable.soot.NoSuchMethodException{
   ...
   static String getLocalId( MethodNode methodNode , Local local ){
   ...
   static String getInstanceFieldId( SootField field ){
      StringBuffer buffer = new StringBuffer();
   ...
   static String getStaticFieldId( SootField field ){
      StringBuffer buffer = new StringBuffer();
      buffer.append("[").append( field.getType().toString() ).append( "]" );
      buffer.append( field.getDeclaringClass().getName() ).append( "." ).
   ...
   static String getInvokeExprId( int invokeExprNum , SootMethod method ){
   ...
   static String getStmtId( int stmtNum , Stmt stmt ){
   ...
   static String getArrayElemId(){
      return "ArrayElem";
   }


   static String getThisId( MethodNode methodNode ){
      StringBuffer buffer = new StringBuffer();
      buffer.append("[").append(methodNode.getName()).append("]").
      append(".this");
      return buffer.toString();
   ...
   static ArrayList CNHT2VL ( Map hashtable ) {
   ...
   */
   static ArrayList cnode2bclass(ArrayList cnodeV )
   {
    ...
    */
   static boolean IsRedundantNode ( String s1, String s2 )
   {
      int len = s1.length();
