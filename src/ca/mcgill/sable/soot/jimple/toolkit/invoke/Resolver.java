...
class Resolver {
   ...
   Resolver( ClassGraphBuilder clgb ) {
      scm = clgb.getManager();
   ...
   HashMap getClassesHT () {
      return classesHT;
   }


   HashMap getMethodsHT () {
      return methodsHT;
   }
   ...
   HashSet getErrorMethods () {
      return errormethods;
   }


   HashSet getErrorInvokeExprs () {
   ...
   void resolveMethods ( Collection callgraph ) {
      System.out.println();
   ...
   void resolveAccessedClassesFromMethod ( SootMethod method ) {
