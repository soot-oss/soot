...
class CallGraphBuilder{
   ...
   CallGraphBuilder( ClassGraphBuilder c ){
      classGBuilder = c;
   }
   ...
   MethodNode getContainerMethod ( InvokeExpr ie ) {
   ...
   SootMethod getSuperMethod( ClassNode classNode , SootMethod originalMethod , SootMethod currMethod ){
   ...
   boolean isLookupPossible ( SootClass baseclass, SootClass topclass ) {
      boolean found = false;
   ...
   MethodNode CreateNodeAndAddToHT( SootMethod method ){
      ...
      else
      {
         ...
         if ( ( methodcount % 10 ) == 0 )
         System.out.print(".");
         // System.out.println("ADDED "+method.getSignature());
   ...
   MethodNode getNode( SootMethod method ) {
   ...
   */
   List getInvokeExprs( SootMethod method ){
      ...
      catch(java.lang.RuntimeException e ){ /* System.out.println ("Soot could not handle "+method.getSignature() ); */ }
   ...
   Set recursiveMethods = new HashSet();
   boolean addedinitialize = false;
   void buildCallGraph( SootMethod method ){
   ...
   */
   void buildCallGraph( ClassGraphBuilder classBuilder ){
   ...
   MethodNode getNode( String methodName ) throws NoSuchMethodNodeException{
      MethodNode methodNode ;
      if ( (methodNode = (MethodNode)MethodNodeHT.get( methodName )) != null )
      return methodNode;
