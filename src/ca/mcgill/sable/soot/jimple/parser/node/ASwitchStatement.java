...
public final class ASwitchStatement extends PStatement
{
    ...
    public PSwitch getSwitch()
    {
        return _switch_;
    }

    public void setSwitch(PSwitch node)
    {
        if(_switch_ != null)
        {
    ...
    private class CaseStmt_Cast implements Cast
    {
        public Object cast(Object o)
        {
            ...
            if((node.parent() != null) &&
                (node.parent() != ASwitchStatement.this))
            {
                node.parent().removeChild(node);
            }
