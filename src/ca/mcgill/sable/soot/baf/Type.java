...
public abstract class Type implements ca.mcgill.sable.util.ValueObject, Switchable
{
    ...
    public Type merge(Type other, ClassManager cm)
    {
        ...
        else if(this instanceof RefType && other instanceof RefType)
        {
            ...
            BClass thisClass = cm.getClass(((RefType) this).className);
            BClass otherClass = cm.getClass(((RefType) other).className);
            BClass javalangObject = cm.getClass("java.lang.Object");
            ...
            // Build thisHierarchy
            {
                BClass BClass = thisClass;
                
                for(;;)
                {
                    thisHierarchy.addFirst(BClass);
                    
                    if(BClass == javalangObject)
                        break;
            ...
            {
                BClass BClass = otherClass;
                
                for(;;)
                {
                    otherHierarchy.addFirst(BClass);
