...
public class BClass
{
    ...
    public BClass(String name, int modifiers)
    {
        this.name = name;
    ...
    */
    ...
    {
        if(isResolved)
            throw new RuntimeException("BClass " + getName() + " already resolved!");
    ...
    */
    ...
    public Field getField(String name) throws ca.mcgill.sable.soot.baf.NoSuchFieldException
    {
        resolveIfNecessary();
        ...
        throw new ca.mcgill.sable.soot.baf.NoSuchFieldException("No field " + name + " in class " + getName());
    }
    ...
    public Method getMethod(String name, List parameterTypes) throws 
        ca.mcgill.sable.soot.baf.NoSuchMethodException
    {
        resolveIfNecessary();
        // inefficient
        ...
        throw new ca.mcgill.sable.soot.baf.NoSuchMethodException();
    }
    ...
    */
    ...
    public void addMethod(Method m) throws AlreadyDeclaredException, DuplicateNameException
    {
        resolveIfNecessary();
    ...
    public void removeMethod(Method m) throws IncorrectDeclarerException
    {
        resolveIfNecessary();
    ...
    public boolean implementsInterface(String name)
    {
        ...
        {
            BClass BClass = (BClass) interfaceIt.next();
    ...
    public void addInterface(BClass interfaceClass) throws DuplicateNameException
    {
        resolveIfNecessary();
    ...
    public void removeInterface(BClass interfaceClass) throws NoSuchInterfaceException 
    {
        if(!implementsInterface(interfaceClass.getName()))
    ...
    /*
    public void setInterfaces(BClass[] interfaces) 
    {
    ...
    */
    ...
    public BClass getSuperClass() throws NoSuperClassException 
    {
        resolveIfNecessary();
        if(superClass == null)
    ...
    public void setSuperClass(BClass c) 
    {
        resolveIfNecessary();
        superClass = c;
    }
