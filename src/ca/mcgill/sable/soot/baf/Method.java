...
public class Method
{
    ...
    public Method(String name, List parameterTypes, Type returnType)
    {
        this.name = name;
    ...
    public Method(String name, List parameterTypes, Type returnType, int modifiers)
    {
        this.name = name;
        this.parameterTypes = new ArrayList();
        this.parameterTypes.addAll(parameterTypes);
    ...
    public Method(String name, List parameterTypes, Type returnType, InstListBody instListBody)
    {
        this.name = name;
        this.parameterTypes = new ArrayList();
        this.parameterTypes.addAll(parameterTypes);
    ...
    public BClass getDeclaringClass() throws NotDeclaredException
    {
        if(!isDeclared)
    ...
    public void addException(BClass e) throws AlreadyThrowsException
    {
    ...
    public void removeException(BClass e) throws DoesNotThrowException
    {
        if(!exceptions.contains(e))
            throw new DoesNotThrowException(e.getName());
    }
    
    public boolean throwsException(BClass e)
    {
