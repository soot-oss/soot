...
class TokenIndex extends AnalysisAdapter
{
    ...
    @Override
    public void caseTMh(@SuppressWarnings("unused") TMh node)
    {
        this.index = 62;
    }
    ...
    @Override
    public void caseTDefaultannotation(@SuppressWarnings("unused") TDefaultannotation node)
    {
        this.index = 97;
    }

    @Override
    public void caseTDeprecatedannotation(@SuppressWarnings("unused") TDeprecatedannotation node)
    {
        this.index = 98;
    }

    @Override
    public void caseTSignatureannotation(@SuppressWarnings("unused") TSignatureannotation node)
    {
        this.index = 99;
    }

    @Override
    public void caseTInnerclassannotation(@SuppressWarnings("unused") TInnerclassannotation node)
    {
        this.index = 100;
    }
