...
public interface Analysis extends Switch
{
    ...
    void caseASingleAnnotationValuesList(ASingleAnnotationValuesList node);
    void caseAMultiAnnotationValuesList(AMultiAnnotationValuesList node);
    void caseASetConstantAnnotationValue(ASetConstantAnnotationValue node);
    void caseAAnnotationAnnotationValue(AAnnotationAnnotationValue node);
    void caseAFieldAnnotationValue(AFieldAnnotationValue node);
    void caseAAnnotationBlockAnnotationValue(AAnnotationBlockAnnotationValue node);
    void caseAClassAnnotationDefinedAnnotation(AClassAnnotationDefinedAnnotation node);
    void caseAVisibilityDefinedAnnotation(AVisibilityDefinedAnnotation node);
    void caseADefaultAnnotationDefinedAnnotation(ADefaultAnnotationDefinedAnnotation node);
    void caseADeprecatedAnnotationDefinedAnnotation(ADeprecatedAnnotationDefinedAnnotation node);
    void caseASignatureAnnotationDefinedAnnotation(ASignatureAnnotationDefinedAnnotation node);
    void caseAInnerclassAnnotationDefinedAnnotation(AInnerclassAnnotationDefinedAnnotation node);
    void caseAAnnotationparamsAnnotationParams(AAnnotationparamsAnnotationParams node);
    ...
    void caseABoolTrueConstant(ABoolTrueConstant node);
    void caseABoolFalseConstant(ABoolFalseConstant node);
    void caseAClzzConstant(AClzzConstant node);
    void caseANullConstant(ANullConstant node);
    void caseAMethodhandlefieldConstant(AMethodhandlefieldConstant node);
    void caseAMethodhandlemethodConstant(AMethodhandlemethodConstant node);
    ...
    void caseTDefaultannotation(TDefaultannotation node);
    void caseTDeprecatedannotation(TDeprecatedannotation node);
    void caseTSignatureannotation(TSignatureannotation node);
    void caseTInnerclassannotation(TInnerclassannotation node);
