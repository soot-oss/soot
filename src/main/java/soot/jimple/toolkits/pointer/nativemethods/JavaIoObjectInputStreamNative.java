...
public class JavaIoObjectInputStreamNative extends NativeMethodClass {
   ...
   */
  public void java_io_ObjectInputStream_latestUserDefinedLoader(SootMethod method, ReferenceVariable thisVar, ReferenceVariable returnVar,
   ...
   *
   * private static native java.lang.Object allocateNewObject(java.lang.Class, java.lang.Class) throws java.lang.InstantiationException,
   * java.lang.IllegalAccessException;
   */
  public void java_io_ObjectInputStream_allocateNewObject(SootMethod method, ReferenceVariable thisVar, ReferenceVariable returnVar,
      ReferenceVariable params[]) {
   ...
   */
  public void java_io_ObjectInputStream_allocateNewArray(SootMethod method, ReferenceVariable thisVar, ReferenceVariable returnVar,
      ReferenceVariable params[]) {
    throw new NativeMethodNotSupportedException(method);
  }
   ...
   * 
   * private static native void bytesToFloats(byte[], int, float[], int, int); private static native void bytesToDoubles(byte[], int, double[], int,
   * int); private static native void setPrimitiveFieldValues(java.lang.Object, long[], char[], byte[]); private static native void
   * setObjectFieldValue(java.lang.Object, long, java.lang.Class, java.lang.Object);
   */
