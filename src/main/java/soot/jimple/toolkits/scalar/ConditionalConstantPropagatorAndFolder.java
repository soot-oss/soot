...
/**
 * Implementation of Conditional Constant Propagation from the paper of Wegman and Zadeck "Constant Propagation with
 * Conditional Branches". https://www.cs.utexas.edu/users/lin/cs380c/wegman.pdf.
 */
...
class CCPFAnalysis extends ForwardBranchedFlowAnalysis<HashMap<Local, Constant>> {
  ...
  Constant meet(Constant c1, Constant c2) {
    /**
     * Meet rules : ∀x, x Π Τ = x x Π ⊥ = ⊥ c_1 Π c_1 = c_1 , where c_1 is a constant c_2 Π c_1 = ⊥, where c_1 and c_2 are
     * constant
     */
  ...
  @Override
  protected void flowThrough(HashMap<Local, Constant> in, Unit s, List<HashMap<Local, Constant>> fallOut,
      List<HashMap<Local, Constant>> branchOuts) {
    // not reachable
