...
class TypeVariable implements Comparable<Object> {
  ...
  public void addParent(TypeVariable variable) {
    ...
    {
      Set<TypeVariable> set = new TreeSet<>(var.children);
      set.add(this);
  ...
  public void addChild(TypeVariable variable) {
    ...
    {
      Set<TypeVariable> set = new TreeSet<>(var.parents);
      set.add(this);
  ...
  public void fixParents() {
    ...
    this.parents = Collections.unmodifiableList(new LinkedList<>(new TreeSet<>(parents)));
  }
  ...
  public void fixChildren() {
    ...
    this.children = Collections.unmodifiableList(new LinkedList<>(new TreeSet<>(children)));
  }
}
