 ...
 *
 * You must pass an {@link AbstractInterproceduralAnalysis} object so that the
...
public class PurityIntraproceduralAnalysis extends ForwardFlowAnalysis<Unit, PurityGraphBox> {
     ...
     * the method return. It is a valid summary that can be used in methodCall
     * if you do interprocedural analysis.
     *
     * @param dst
     */
    ...
    /**
     * Perform purity analysis on the Jimple unit graph g, as part of a larger
     * interprocedural analysis. Once constructed, you may call copyResult and
