...
/**
 * Exception that is thrown when code tries to resolve a reference for some field "fld: type1", but the target class already declares a field "fld:
 * type2". In other words, this exception denotes a mismatch in expected and declared type.
 * 
 * @author Steven Arzt
 *
 */
