 ...
 * i.e. entities that do not exist in the original bytecode. This can, for instance, be used to
 * exclude such entities from being written out or processed by clients.
 *
