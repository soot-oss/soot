...
/**
 * Analysis that implements the LocalUses interface. Uses for a Local defined at a given Unit are returned as a list of UnitValueBoxPairs each
 * containing a Unit that use the local and the Local itself wrapped in a ValueBox.
 */
public class SimpleLocalUses implements LocalUses {
  ...
  /**
   * Construct the analysis from a UnitGraph representation of a method body and a LocalDefs interface. This supposes that a LocalDefs analysis must
   * have been computed prior.
   *
   * <p>
  ...
  /**
   * Uses for a Local defined at a given Unit are returned as a list of UnitValueBoxPairs each containing a Unit that use the local and the Local
