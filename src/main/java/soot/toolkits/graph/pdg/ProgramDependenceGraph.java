...
public interface ProgramDependenceGraph extends MutableEdgeLabelledDirectedGraph<PDGNode, String> {
  ...
  /**
   * @return A List of weak regions, generated by RegionAnalysis for the corresponding control flow graph (These are Regions and not PDGRegions.)
   */
  public List<Region> getWeakRegions();

  /**
   * @return A List of strong regions, generated when constructing the program dependence graph (These are Regions and not PDGRegions.)
   */
  ...
  /**
   * @return The root node of the PDG, which is essentially the same as the start region but packaged in its PDGNode, which can be used to traverse
   *         the graph, etc.
   */
