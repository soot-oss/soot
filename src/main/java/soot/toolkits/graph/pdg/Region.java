...
/**
 * This class was originally designed to represent a weak region. Later, PDGRegion was designed to represent a richer region representation but since
 * there were cases that we wanted to enforce the use of Region instead of PDGRegion, and for some other compatibility issues, we chose not to
 * eliminate this class and even not to factor it into a common abstract class.
 * 
 * One major contributing factor to the above is that, a Region can exist independent from a PDG since they are generated by RegionAnalysis, whereas a
 * PDGRegion is generated by a PDG.
 * 
