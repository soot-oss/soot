...
/**
 * ldtoken was split up by ILspy: LdTypeToken for types and LdMemberToken Load a type handle token (e.g. reflection)
 */
public class CilLdTypeTokenInstruction extends AbstractCilnstruction {
  public CilLdTypeTokenInstruction(ProtoIlInstructions.IlInstructionMsg instruction, DotnetBody dotnetBody,
      CilBlock cilBlock) {
