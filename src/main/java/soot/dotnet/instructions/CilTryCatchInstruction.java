...
public class CilTryCatchInstruction extends AbstractCilnstruction {
    ...
    public void jimplify(Body jb) {
        ...
        for (ProtoIlInstructions.IlTryCatchHandlerMsg handlerMsg :
                protoHandlersList) {
            ...
            if (handlerMsg.getHasFilter()) {
                CatchFilterHandlerBody filterHandler = new CatchFilterHandlerBody(dotnetBody, handlerMsg, exceptionVar, gotoEndTryCatchBlockNop);
