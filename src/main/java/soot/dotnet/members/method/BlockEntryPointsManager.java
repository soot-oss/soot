...
/**
 * Part of DotnetBody
 * Manager for entry points (leave, branch instructions)
 * ILSpy AST Blocks are labeled with a string. Strings are stored and replaced afterwards with the right JimpleStmt
 */
public class BlockEntryPointsManager {

    /**
     * Every method contains blocks of instructions targeted with a label.
     * These are stored while visiting blocks and used afterwards to swap the goto values.
     */
     ...
     * These are swapped afterwards with the real goto values, after all method blocks are visited.
     */
