 ...
 * SourceLocator -> ClassProvider -> ClassSource -> MethodSource (DotnetMethod)
 */
public class DotnetMethod extends AbstractDotnetMember {
    ...
    public boolean isStatic() { return protoMethod.getIsStatic()
            || protoMethod.getName().contains(STATIC_CONSTRUCTOR_NAME)
    ...
    /**
     * Create SootMethod with specific MethodSource (used by Events and Properties)
     * Events and Properties have other sources for method bodies
     * @param methodSource
     * @return
     */
     ...
     * @param ilFunctionMsg ProtoMsg Method Body
     * @return
     */
     ...
     * @param method e.g. MyMethod(ref param1, param2)
     */
     ...
     * @param methodName dotnet constructor name
