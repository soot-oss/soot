 ...
 * SourceLocator -> ClassProvider -> ClassSource (DotnetType) -> MethodSource
 */
public class DotnetType {
     ...
     * @param sootClass SootClass to fill with information
    ...
    private void resolveProperties(SootClass declaringClass) {
        ...
        for (ProtoAssemblyAllTypes.PropertyDefinition property : typeDefinition.getPropertiesList()) {
            ...
            if (dotnetProperty.getCanSet()) {
                ...
                if (setter == null || declaringClass.declaresMethod(setter.getName(), setter.getParameterTypes(), setter.getReturnType())) {
                    continue;
                }
    ...
    private void resolveAttributes(SootClass declaringClass) {
        ...
        for (ProtoAssemblyAllTypes.AttributeDefinition attrMsg :
                typeDefinition.getAttributesList()) {
            try {
