 ...
 *
 * A <code>CFGOptionMatcher</code> maintains a set of named options, and provides a means for matching abbreviated option values against those names.
 */
...
public class CFGOptionMatcher {
  ...
  /**
   * The type stored within a <code>CFGOptionMatcher</code>. Options to be stored in a <code>CFGOptionMatcher</code> must extend this class.
   */
  ...
  /**
   * Searches the options in this <code>CFGOptionMatcher</code> looking for one whose name begins with the passed string (ignoring the case of letters
   * in the string).
   *
   * @param quarry
  ...
  /**
   * Returns a string containing the names of all the options in this <code>CFGOptionMatcher</code>, separated by '|' characters. The string is
   * intended for use in help messages.
   *
   * @param initialIndent
