...
/**
 * A visitor that builds a list of instructions from the Jimple expressions it
 * visits.<br>
 * <br>
 * Use {@link Switchable#apply(soot.util.Switch)} with this visitor to add
 * statements. These are added to the instructions in the
 * {@link StmtVisitor}.<br>
 * If the expression is part of an assignment or an if statement, use
 * {@link #setDestinationReg(Register)} and {@link #setTargetForOffset(Stmt)},
 * respectively.
 * 
 * @see StmtVisitor
 */
