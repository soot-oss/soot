...
/**
 * The "45cc" instruction format <br>
 * It is used by the "invoke-polymorphic" opcode
 */
public class Insn45cc extends AbstractInsn implements FiveRegInsn {

  private int regCount;

  private final Reference referencedItem;

  private final Reference referencedItem2;

  public Insn45cc(Opcode opc, int regCount, Register regD, Register regE, Register regF, Register regG, Register regA,
      Reference referencedItem, Reference referencedItem2) {
    super(opc);
  ...
  protected BuilderInstruction getRealInsn0(LabelAssigner assigner) {
    ...
    return new BuilderInstruction45cc(opc, regCount, regDNumber, regENumber, regFNumber, regGNumber, regANumber,
        referencedItem, referencedItem2);
  }
