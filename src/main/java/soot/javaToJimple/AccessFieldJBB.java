...
public class AccessFieldJBB extends AbstractJimpleBodyBuilder {
   ...
   * 
   * 
   * // here is where we need to return the field using get method return handleCall(accessField.field(), accessField.getMeth(), null, null); //
   * return ext().createExpr(accessField.field()); } else { return ext().createExpr(expr); } }
   */
