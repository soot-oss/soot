...
{ 
	final static Logger logger = LoggerFactory
			.getLogger(CommonSubexpressionEliminator.class);
    ...
    protected void internalTransform(Body b, String phaseName, Map<String,String> options)
    {
        ...
        while (unitsIt.hasNext())
        {
            ...
            if (s instanceof AssignStmt)
            {
                ...
                //logger.info("availExprs: "+availExprs);
                ...
                if (availExprs.contains(ev))
                {
                    ...
                    //logger.info("availPairs: "+availPairs);
                    ...
                    while (availIt.hasNext())
                    {
                        ...
                        if (up.getValueBox().getValue().equivTo(v))
                        {
                            ...
                            //logger.info("added tag to : "+copier);
                            //logger.info("added tag to : "+s);
                        }
                    }
                }
            }
