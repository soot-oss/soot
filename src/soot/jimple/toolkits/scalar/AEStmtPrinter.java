    ...
    public void printStatementsInBody(Body body, java.io.PrintWriter out, boolean isPrecise, boolean isNumbered)
    {
        ...
        while(unitIt.hasNext()) {
            ...
            // Print appropriate header.
                ...
                out.println("     // IN: "+ae.getAvailableEquivsBefore(currentStmt));
                if(isPrecise)
            ...
            out.print(";"); 
            out.println();
                out.println("     // OUT: "+ae.getAvailableEquivsAfter(currentStmt));
        }
