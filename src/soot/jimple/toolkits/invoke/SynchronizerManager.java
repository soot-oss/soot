...
public class SynchronizerManager {
	...
	public SootMethod getClassFetcherFor(SootClass c) {
		...
		for (; true; methodName = "_" + methodName) {
			...
			if (!m.getSignature().equals(
					"<" + c.getName().replace('.', '$') + ": java.lang.Class " + methodName + "(java.lang.String)>"))
				continue;
			...
			/*
			 * r0 := @parameter0: java.lang.String; $r2 = .staticinvoke
			 * <java.lang.Class: java.lang.Class forName(java.lang.String)>(r0);
			 * .return $r2;
			 *
	...
	public SootMethod createClassFetcherFor(SootClass c, String methodName) {
		// Create the method
		SootMethod method = Scene.v().makeSootMethod(methodName,
				Arrays.asList(new Type[] { RefType.v("java.lang.String") }), RefType.v("java.lang.Class"),
				Modifier.STATIC);
		...
		// Create the method body
		{
					...
					asi = Jimple.v()
							.newAssignStmt(l_r2,
									Jimple.v().newStaticInvokeExpr(
											Scene.v()
													.getMethod("<java.lang.Class: java.lang.Class"
			...
			units.add(
					Jimple.v().newAssignStmt(l_r4, Jimple.v().newNewExpr(RefType.v("java.lang.NoClassDefFoundError"))));
			...
			units.add(Jimple.v()
					.newInvokeStmt(Jimple.v()
							.newSpecialInvokeExpr(l_r4, Scene.v()
									.getMethod("<java.lang.NoClassDefFoundError: void" + " <init>(java.lang.String)>")
									.makeRef(), Arrays.asList(new Value[] { l_r5 }))));

			// add .throw $r4;
			units.add(Jimple.v().newThrowStmt(l_r4));

			body.getTraps().add(Jimple.v().newTrap(Scene.v().getSootClass("java.lang.ClassNotFoundException"), asi,
	...
	public void synchronizeStmtOn(Stmt stmt, JimpleBody b, Local lock) {
		...
		// appropriate place.
		{
			...
			Trap newTrap = Jimple.v().newTrap(Scene.v().getSootClass("java.lang.Throwable"), stmt,
					(Stmt) units.getSuccOf(stmt), handlerStmt);
