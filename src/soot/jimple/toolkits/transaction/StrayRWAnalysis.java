...
public class StrayRWAnalysis extends BackwardFlowAnalysis
{
    ...
    StrayRWAnalysis(UnitGraph graph, Body b, List tns)
	{
		super(graph);
		body = b;
		this.tns = tns;
    ...
    protected void flowThrough(Object inValue, Object unit, Object outValue)
    {
    	...
    	{
    		Transaction tn = new Transaction((Stmt) unit, body.getMethod());
    		tn.begin = (Stmt) unit;
