...
{ 
    TradEdgeContextStripper( Rsrcc_srcm_stmt_kind_tgtc_tgtm in, Qsrcc_srcm_stmt_kind_tgtc_tgtm out ) {
        super(in, out);
    }
    ...
    public boolean update() {
        ...
        for( Iterator tIt = in.iterator(); tIt.hasNext(); ) {
            ...
            Rsrcc_srcm_stmt_kind_tgtc_tgtm.Tuple newT =
                new Rsrcc_srcm_stmt_kind_tgtc_tgtm.Tuple(
                        null, t.srcm(), t.stmt(), t.kind(), null, t.tgtm() );
            if( seen.add(newT) ) {
                out.add(newT);
                change = true;
            }
