...
{ 
    TradObjSensVirtualContextManager( Rctxt_local_obj_srcm_stmt_kind_tgtm in, Qsrcc_srcm_stmt_kind_tgtc_tgtm out ) {
        super( in, out );
    }
    public void update() {
        for( Iterator tIt = in.iterator(); tIt.hasNext(); ) {
            ...
            out.add( t.ctxt(), t.srcm(), t.stmt(), t.kind(), t.obj(), t.tgtm() );
        }
    }
}
