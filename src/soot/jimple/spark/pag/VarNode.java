...
public abstract class VarNode extends ValNode implements Comparable {
	final static Logger logger = LoggerFactory.getLogger(VarNode.class);
	...
	VarNode other = (VarNode) o;
        if( other.finishingNumber == finishingNumber && other != this ) {
            logger.info( "This is: "+this+" with id "+getNumber()+" and number "+finishingNumber );
            logger.info( "Other is: "+other+" with id "+other.getNumber()+" and number "+other.finishingNumber );
