 ...
 */
public final class SharedPointsToSet extends PointsToSetInternal {
    public SharedPointsToSet( Type type, PAG pag ) {
        super( type );
        this.pag = pag;
    }
    ...
    private final boolean nativeAddAll( SharedPointsToSet other, SharedPointsToSet exclude ) {
        ...
        if( other.bits != null ) {
            ...
            SharedBitSet ebits = ( exclude==null ? null : exclude.bits );
    ...
    public final boolean addAll( final PointsToSetInternal other,
        ...
        if( exclude != null && !(exclude instanceof SharedPointsToSet) )
            return superAddAll( other, exclude );
        return nativeAddAll( (SharedPointsToSet) other, (SharedPointsToSet) exclude );
    }
    ...
    public final static P2SetFactory getFactory() {
        return new P2SetFactory() {
            public final PointsToSetInternal newSet( Type type, PAG pag ) {
                return new SharedPointsToSet( type, pag );
            }
        };
    }
    ...
    protected final void convertToBits() {
        if( bits != null ) return;
        bits = new SharedBitSet( pag.getAllocNodeNumberer().size() );
    ...
    private SharedBitSet bits = null;
    private PAG pag;
