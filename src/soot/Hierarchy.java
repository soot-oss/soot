 ...
 *
 * The general convention is that if a method name contains "Including", then it
 * returns the non-strict result; otherwise, it does a strict query (e.g. strict
 * superclass).
 */
public class Hierarchy {
	...
	/**
	 * Checks whether check is a visible class in view of the from class. It
	 * assumes that protected and private classes do not exit. If they exist and
