 ...
 * folding): <code>soot.Main -O -p jop.cp disabled -p jop.cbf disabled
...
{
    private static SConstantPropagatorAndFolder instance = new SConstantPropagatorAndFolder();
    private SConstantPropagatorAndFolder() {}
    public static SConstantPropagatorAndFolder v() { return instance; }
    ...
    protected void internalTransform(Body b, String phaseName, Map options)
    {
        ...
        if (soot.Main.isVerbose)
            System.out.println("[" + sBody.getMethod().getName() +
