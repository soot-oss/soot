...
public class PseudoReverseTopologicalOrderer2
{
    public static final boolean REVERSE = true;
    public PseudoReverseTopologicalOrderer2() {}
    public PseudoReverseTopologicalOrderer2(boolean isReversed) { mIsReversed = isReversed;}
    ...
    private static PseudoReverseTopologicalOrderer2 instance =
    	new PseudoReverseTopologicalOrderer2();

    public static PseudoReverseTopologicalOrderer2 v()
    {
    	return instance;
    }
