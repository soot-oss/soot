...
public class PseudoTopologicalOrderer2
{
    public static final boolean REVERSE = true;
    public PseudoTopologicalOrderer2() {}
    public PseudoTopologicalOrderer2(boolean isReversed) { mIsReversed = isReversed;}
    ...
    private static PseudoTopologicalOrderer2 instance =
    	new PseudoTopologicalOrderer2();

    public static PseudoTopologicalOrderer2 v()
    {
    	return instance;
    }
	...
	reverseOrder = PseudoReverseTopologicalOrderer2.v().newList(g);
