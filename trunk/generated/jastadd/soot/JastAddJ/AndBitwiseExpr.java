...
public class AndBitwiseExpr extends BitwiseExpr implements Cloneable {
    public void flushCache() {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public AndBitwiseExpr clone() throws CloneNotSupportedException {
        AndBitwiseExpr node = (AndBitwiseExpr)super.clone();
        node.in$Circle(false);
        node.is$Final(false);
    return node;
    }
     @SuppressWarnings({"unchecked", "cast"})  public AndBitwiseExpr copy() {
      try {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public AndBitwiseExpr fullCopy() {
        AndBitwiseExpr res = (AndBitwiseExpr)copy();
    ...
    // Declared in Expressions.jrag at line 810
 ...
 @SuppressWarnings({"unchecked", "cast"})     public Constant constant() {
    ...
    // Declared in PrettyPrint.jadd at line 425
