...
\begin{small}
\textbf{\texttt{\red java soot.Main -W -f jimple}}
...
\textbf{\texttt{\red      -p jb use-original-names:true }}
...
keep the original variable names, if available in attributes.
...
\textbf{\texttt{\red      -p cg.spark on }}

\textbf{\texttt{\red      -p cg.spark simplify-offline:true}}
...
call graph,  with Spark simplifying the problem by collapsing
...
\textbf{\texttt{\red      -p jop on -p jop.cse on   }}

\textbf{\texttt{\red      -p wjop on  -p wjop.smb on }}
